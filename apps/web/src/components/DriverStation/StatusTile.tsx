...
function commsToneFromConnections(
	...
	if (halConnection === "connected" && runConnection === "connected")
		return "ok";
	if (halConnection === "reconnecting" || runConnection === "reconnecting")
		return "warn";
	return "bad";
}
...
export function StatusTileRow({
	...
	const joystickTone = joystickToneFromStatus(
		joystickStatus,
		inputMode,
		keyboardCaptureActive,
	);

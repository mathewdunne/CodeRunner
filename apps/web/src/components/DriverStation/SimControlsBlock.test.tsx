...
describe("SimControlsBlock", () => {
  test("start button enabled when idle and sessionReady", () => {
    render(
      <SimControlsBlock runStatus="idle" sessionReady={true} onStart={() => {}} onStop={() => {}} onRestart={() => {}} />,
    );
  ...
  test("start button disabled when not sessionReady", () => {
    render(
      <SimControlsBlock runStatus="idle" sessionReady={false} onStart={() => {}} onStop={() => {}} onRestart={() => {}} />,
    );
  ...
  test("stop button enabled when running", () => {
    render(
      <SimControlsBlock runStatus="running" sessionReady={true} onStart={() => {}} onStop={() => {}} onRestart={() => {}} />,
    );
  ...
  test("calls onStart/onStop/onRestart on click", () => {
    ...
    render(
      <SimControlsBlock runStatus="running" sessionReady={true} onStart={onStart} onStop={onStop} onRestart={onRestart} />,
    );
    fireEvent.click(screen.getByTestId("run-button").closest("button") ?? screen.getByTestId("run-button"));

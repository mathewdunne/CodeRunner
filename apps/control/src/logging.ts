...
const VALID_LEVELS = ["trace", "debug", "info", "warning", "error", "fatal"] as const;
...
export function defaultLogLevel(): LogLevel {
  const fromEnv = parseLogLevelEnv(typeof Bun !== "undefined" ? Bun.env.LOG_LEVEL : process.env.LOG_LEVEL);

...
export async function createProjectArchive(projectDir: string, archivePath: string): Promise<void> {
  await runTar(["-czf", archivePath, "-C", projectDir, "."]);
}

export async function restoreProjectArchive(projectDir: string, archivePath: string): Promise<void> {

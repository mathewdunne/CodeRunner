...
import { requireWebSocketOrigin, requireWorkspaceOwnership } from "../auth/middleware";
...
export async function handleWorkspaceRoute(
  ...
  const { storage, runs, runtimeProvider, halsim, gamepad, nt4Auto, upstreamFetch } = ctx;

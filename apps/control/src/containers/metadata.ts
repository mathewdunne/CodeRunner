...
export function publishedPortFor(container: DockerInspectContainer, port: number): PublishedPort | null {
...
export function containerRuntimeState(container: DockerInspectContainer): ContainerState {
...
export function v2LabelsMatch(container: DockerInspectContainer, workspaceId: WorkspaceId): boolean {

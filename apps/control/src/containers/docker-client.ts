...
import type { DockerCommandResult, DockerInspectContainer, DockerRunner } from "./types";
...
export function dockerError(args: string[], result: DockerCommandResult): Error {

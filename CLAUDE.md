...
When other top-level dirs appear (`apps/`, `packages/`, etc.) they will be npm/pnpm workspaces for the TS code. Don't add them speculatively — wait until a task needs them.
...
- Verify: connect desktop AdvantageScope (`C:\Users\Public\wpilib\2026\advantagescope`) to `localhost:5810`.

...
## Corpus Check
- 997 files · ~844,920 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16051 nodes · 28988 edges · 1603 communities (1074 shown, 529 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 392 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f9d9b5ec`
...
1. `main()` - 462 edges
2. `Robot()` - 415 edges
3. `Change Log` - 172 edges
4. `TeleopPeriodic()` - 161 edges
5. `RobotPeriodic()` - 154 edges
6. `Change Log` - 149 edges
7. `DisabledInit()` - 133 edges
8. `TeleopInit()` - 133 edges
9. `DriveSubsystem` - 125 edges
10. `AutonomousInit()` - 119 edges

## Surprising Connections (you probably didn't know these)
- `saveAllowlist()` --calls--> `Rename`  [INFERRED]
  apps/control/src/auth/allowlist.ts → data/users/ws_0894ecc6ddba8528fd4a9b9067e2ce37/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `restoreProjectArchive()` --calls--> `Rename`  [INFERRED]
  apps/control/src/app/archive-utils.ts → data/users/ws_0894ecc6ddba8528fd4a9b9067e2ce37/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `restoreArchive()` --calls--> `Rename`  [INFERRED]
  scripts/restore.ts → data/users/ws_0894ecc6ddba8528fd4a9b9067e2ce37/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `restoreProjectArchive()` --calls--> `Rename`  [INFERRED]
  apps/control/src/app.ts → data/users/ws_0894ecc6ddba8528fd4a9b9067e2ce37/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
...
## Communities (1603 total, 529 thin omitted)
...
Cohesion: 0.01
Nodes (9): Command, ArcadeDrive, DriveTime, ExampleCommand, TurnTime, m_autoTime(), RapidReactCommandBot, SlowDriveSpeedCommand (+1 more)
...
Cohesion: 0.02
Nodes (174): createWebSocketHandlers(), ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp() (+166 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (196): AuthenticationForceNewSessionOptions, AuthenticationProviderInformation, AuthenticationProviderOptions, AuthenticationSession, AutoClosingPair, Breakpoint, BreakpointsChangeEvent, CallHierarchyItem (+188 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (9): ReplaceMeSubsystem, SubsystemBase, log(), output(), val(), DriveSubsystem, SubsystemBase(), log() (+1 more)
...
Cohesion: 0.03
Nodes (131): AccessibilityInformation, AuthenticationGetSessionOptions, AuthenticationProvider, AuthenticationProviderAuthenticationSessionsChangeEvent, ChatErrorDetails, ChatFollowup, ChatParticipant, ChatRequestHandler (+123 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (131): AuthenticationSessionAccountInformation, AuthenticationSessionsChangeEvent, BranchCoverage, CallHierarchyIncomingCall, CallHierarchyOutgoingCall, CancellationTokenSource, ChatContext, ChatPromptReference (+123 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (23): RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer (+15 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (25): codeContainerName(), containerName(), ContainerOrchestrator, containerRuntimeState(), dockerError(), dockerPortBindError(), isLoopbackHost(), labelsMatch() (+17 more)
...
Cohesion: 0.03
Nodes (87): Rename, input, stripped, apiError(), apiErrorResponse(), AppSocket, assertRealPathInside(), AssetManifest (+79 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (63): sendUpstreamWebSocketMessage(), AppSocket, ControlApp, ControlAppOptions, GamepadSocketData, HalSimSocketData, ImportSocketData, Nt4SocketData (+55 more)
...
Cohesion: 0.05
Nodes (21): ArmSimulationTest, TEST_P(), AlertTest, AllianceTest, AutonomousTest, DigitalCommunicationTest, EnabledTest, TEST_P() (+13 more)
...
Cohesion: 0.06
Nodes (74): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+66 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (39): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), defaultDockerRunner(), dockerError(), dockerPortBindError(), inspectContainer() (+31 more)
...
Cohesion: 0.05
Nodes (65): addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist() (+57 more)

### Community 25 - "Community 25"
Cohesion: 0.03
Nodes (75): AdminActionResponse, adminActionResponseSchema, AdminStatusResponse, adminStatusResponseSchema, AdminWorkspaceStatus, adminWorkspaceStatusSchema, AllianceStation, AuthProvider (+67 more)
...
Cohesion: 0.05
Nodes (40): first, NUM_RUNS, second, bashCalls, cloneCall, ctx, importer, mock (+32 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (5): FlywheelIOSim, FlywheelIO, HoodIOSim, HoodIO, ShooterSubsystem
...
Cohesion: 0.05
Nodes (43): ANSI, colorize(), configureLogging(), createSink(), formatAttrs(), formatAttrValue(), formatRecord(), formatTimestamp() (+35 more)
...
Cohesion: 0.04
Nodes (44): 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+36 more)
...
Cohesion: 0.04
Nodes (43): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.24.1, 0.30.0, 0.30.1, 0.31.0, 0.31.1 (+35 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (43): 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.34.0 - 2021-05-26 (+35 more)

### Community 46 - "Community 46"
Cohesion: 0.07
Nodes (29): AutoPanel(), AutoPanelProps, ControlsPanel(), ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES (+21 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (34): BigButton(), BigButtonProps, EnableDisableRow(), EnableDisableRowProps, onSetEnabled, TONE_ACTIVE, MODE_CLASSES, MODE_LABELS (+26 more)

### Community 49 - "Community 49"
Cohesion: 0.06
Nodes (32): patchCall, { result }, updatedResponse, VALID_RESPONSE, useAutoChoosers(), UseAutoChoosersReturn, { result }, { unmount } (+24 more)
...
Cohesion: 0.1
Nodes (16): runActiveDuration, runBuildDuration, consumeLines(), defaultRunCommandFactory(), dockerRunScript(), lineLooksReady(), log, randomRunId() (+8 more)
...
Cohesion: 0.11
Nodes (25): acceptWebSocket(), ActiveRun, activeRuns, collectProcess(), delay(), docker(), dockerExec(), handleRun() (+17 more)
...
Cohesion: 0.06
Nodes (33): 1. GCP project, 2. Terraform state bucket, 3. Configure Terraform vars, 4. Apply, 5. Populate Secret Manager, 6. DNS, 7. Re-render config on the VM, 8. Configure GitHub repo for the deploy workflow (+25 more)
...
Cohesion: 0.12
Nodes (30): advantageScopeUrl(), appendConsole(), consoleEl, currentSessionUser(), editor, editorEl, envValue(), flushSave() (+22 more)

### Community 85 - "Community 85"
Cohesion: 0.15
Nodes (17): body, body, body, body, absolute, refs, headers, received (+9 more)

### Community 86 - "Community 86"
Cohesion: 0.11
Nodes (20): EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip() (+12 more)
...
Cohesion: 0.07
Nodes (28): 0.23.2, 0.23.4, 0.23.6, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2 (+20 more)
...
Cohesion: 0.08
Nodes (27): first, NUM_RUNS, parsed, slugArb, allianceStationSchema, authProvidersResponseSchema, autoChooserPatchSchema, autoChoosersResponseSchema (+19 more)
...
Cohesion: 0.15
Nodes (23): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 7. Cache Cleanup, 8. Monitoring (+15 more)
...
Cohesion: 0.13
Nodes (14): AppFixtures, AppOptions, defaultRunCommandFactory, startFakeHalsim(), startFakeVscode(), AppFixture, FakeHalsimHandle, FakeVscodeHandle (+6 more)
...
Cohesion: 0.11
Nodes (3): DriveCommands, WheelRadiusCharacterizationState, SysIDCommands
...
Cohesion: 0.09
Nodes (3): PhoenixOdometryThread, PhoenixUtil, VirtualPD
...
Cohesion: 0.15
Nodes (12): seedRuntimeMissing(), seedRuntimeRunning(), snapshot, cookie, snapshot, console, cookie, makeScriptedRunCommandFactory() (+4 more)

### Community 163 - "Community 163"
Cohesion: 0.13
Nodes (5): FakeSocket, Listener, { result }, { unmount }, FakeWebSocket
...
Cohesion: 0.18
Nodes (19): Admin status API, code:bash (bun run restore -- <backup-dir> --dry-run                   ), code:bash (# on the laptop, after stopping local dev), code:bash (bun run docker:cleanup), code:bash (bun run docker:cleanup -- --dry-run), code:bash (rm -rf data/users/<workspaceId>/home/), code:bash (rm -rf data/users/<workspaceId>/logs/runs/*), code:bash (for dir in data/users/*/; do) (+11 more)
...
Cohesion: 0.14
Nodes (3): GyroIONavX, GyroIOPigeon2, GyroIO
...
Cohesion: 0.14
Nodes (14): 2.1 Set Breakpoint Based on Hypothesis, 2.2 Check Session State (Call ONCE, Then Act!), 2.4 Automatic Cleanup on Restart, 2.5 Fallback: When debugJavaApplication Fails or Times Out, code:block12 (execute/getTerminalOutput(id="Java Debug")), code:markdown ("Debug session failed to start automatically.), code:block14 (vscjava.vscode-java-debug/getDebugSessionInfo()), code:block15 (1. vscjava.vscode-java-debug/setJavaBreakpoint(filePath="App) (+6 more)
...
Cohesion: 0.18
Nodes (3): WorkspacePage, status, wsp
...
Cohesion: 0.31
Nodes (9): 6. Backup and Restore, code:bash (bun run backup), code:block19 (data/backups/2026-05-16-151038/), code:bash (bun run backup -- --output /path/to/backup     # custom outp), code:bash (bun run restore -- <backup-dir>), Create a backup, Recommended backup schedule, Restore from backup (+1 more)
...
Cohesion: 0.4
Nodes (5): After, Before, code:java (public class Foo {), code:java (public class Bar {), Examples
...
Cohesion: 0.5
Nodes (4): 2.3 Decision Matrix (STRICT!), code:block10 (vscjava.vscode-java-debug/getDebugSessionInfo()  // Returns ), code:block11 (vscjava.vscode-java-debug/getDebugSessionInfo()  // Check ag), code:block9 (vscjava.vscode-java-debug/getDebugSessionInfo()  // Returns )
...
## Knowledge Gaps
- **3845 isolated node(s):** `nosniff`, `cookie`, `console`, `consoleErrors`, `leaseErrors` (+3840 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **529 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 59` to `Community 0`, `Community 650`, `Community 47`, `Community 144`, `Community 29`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 58` to `Community 16`, `Community 21`, `Community 15`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `isWorkspaceSlug()` connect `Community 61` to `Community 25`, `Community 101`?**

# Graph Report - FRC-Programming-Training-Sim  (2026-05-16)

## Corpus Check
- 5208 files · ~3,640,872 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15134 nodes · 26615 edges · 1553 communities (1014 shown, 539 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 391 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ddd15b2a`
...
## Communities (1553 total, 539 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (46): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+38 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (14): PreSpinFlywheelCommand, WaitUntilHopperIsEmptyCommand, Command, ReplaceMeCommand, DriveTime, DriveToPoseCommand, SysIDCommands, TurnTime (+6 more)
...
Cohesion: 0.03
Nodes (229): AuthenticationForceNewSessionOptions, AuthenticationProvider, AuthenticationSessionAccountInformation, AutoClosingPair, BranchCoverage, Breakpoint, BreakpointsChangeEvent, CallHierarchyOutgoingCall (+221 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (229): AccessibilityInformation, AuthenticationGetSessionOptions, AuthenticationProviderAuthenticationSessionsChangeEvent, AuthenticationProviderInformation, AuthenticationProviderOptions, AuthenticationSession, AuthenticationSessionsChangeEvent, CallHierarchyIncomingCall (+221 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (154): ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp(), DockerRunner (+146 more)
...
Cohesion: 0.02
Nodes (17): RobotContainer, RobotContainer, ShootUntilHopperEmptyCommand, Initialize(), IsFinished(), ReleaseHatch, SetBrakeModeCommand, ShiftChangeRumbleLEDCommand (+9 more)
...
Cohesion: 0.05
Nodes (24): codeContainerName(), containerName(), ContainerOrchestrator, containerRuntimeState(), dockerError(), dockerPortBindError(), isLoopbackHost(), leaseContainerNameFor() (+16 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (92): handleUploadAsset(), userAssetsPath(), getSessionFromRequest(), requireSession(), input, stripped, apiError(), apiErrorResponse() (+84 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (11): DoubleSupplier, ModuleIOSpark, ExtensionIOSpark, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand, SpindexerIOSpark (+3 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (10): Main, Main, Main, RobotBase, Main, Main, Main, Main (+2 more)
...
Cohesion: 0.06
Nodes (69): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+61 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (4): DriveCommands, WheelRadiusCharacterizationState, DriveSubsystem, Module
...
Cohesion: 0.05
Nodes (48): ConsolePane(), ConsolePaneProps, EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps (+40 more)
...
Cohesion: 0.05
Nodes (40): sendUpstreamWebSocketMessage(), AppSocket, createWebSocketHandlers(), log, WebSocketHandlerContext, DEFAULT_PORT, GamepadLease, GamepadLeaseResolver (+32 more)
...
Cohesion: 0.05
Nodes (4): TrenchDuckCommand, TurretCommands, LaunchCalculator, AllianceFlipUtil
...
Cohesion: 0.06
Nodes (48): ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange, loadControlConfig() (+40 more)
...
Cohesion: 0.06
Nodes (44): addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist() (+36 more)
...
Cohesion: 0.06
Nodes (34): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimer(), MatchTimerProps, STATION_LABELS, STATIONS (+26 more)
...
Cohesion: 0.04
Nodes (45): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.0, 0.30.1 (+37 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (44): 0.10.0 - 2018-6-27, 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.34.0 - 2021-05-26 (+36 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (44): 0.12.1 - 2018-8-31, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+36 more)

### Community 41 - "Community 41"
Cohesion: 0.05
Nodes (4): ExampleGlobalMeasurementSensor, ExampleGlobalMeasurementSensor, ExampleGlobalMeasurementSensor, ChassisTrapezoidalController
...
Cohesion: 0.06
Nodes (30): AutoPanel(), AutoPanelProps, ControlsPanel(), ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES (+22 more)
...
Cohesion: 0.04
Nodes (6): GyroIONavX, GyroIOPigeon2, GyroIOSim, ModuleIOSim, GyroIO, VisionIOPhotonVision
...
Cohesion: 0.07
Nodes (29): CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun(), ConsoleLine(), ConsolePanel(), ConsolePanelProps, ConsoleTab (+21 more)

### Community 55 - "Community 55"
Cohesion: 0.1
Nodes (26): AdminLayout(), Tab, tabs, useAdminPoll(), Allowlist(), AllowlistData, AuditEntry, AuditLog() (+18 more)
...
Cohesion: 0.08
Nodes (15): Listener, FakeWebSocket, setupBridgeAndSocket(), bridge, enabledDisable, FakeWebSocket, flush, joystick (+7 more)
...
Cohesion: 0.07
Nodes (27): ControlApp, ControlAppOptions, GamepadSocketData, HalSimSocketData, ImportSocketData, Nt4SocketData, RunSocketData, VscodeSocketData (+19 more)
...
Cohesion: 0.14
Nodes (18): body, body, body, body, absolute, refs, headers, received (+10 more)
...
Cohesion: 0.08
Nodes (3): DefaultDrive, Execute(), TunableDouble
...
Cohesion: 0.07
Nodes (23): 0.1.0 - 2018-10-19, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+15 more)
...
Cohesion: 0.07
Nodes (28): 0.1.0 - 2018-10-19, 0.23.1, 0.23.6, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2 (+20 more)
...
Cohesion: 0.1
Nodes (4): VisionIOPhotonVisionSim, VisionConsumer, VisionSubsystem, VisionIOPhotonVision
...
Cohesion: 0.17
Nodes (23): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token), code:alloy (prometheus.scrape "control_plane" {) (+15 more)
...
Cohesion: 0.16
Nodes (21): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 5. Configuration, Between class sessions (+13 more)
...
Cohesion: 0.14
Nodes (14): GamepadFrame, GamepadInfo, listConnectedGamepads(), makeLabel(), FakePad, { result }, useGamepad(), UseGamepadResult (+6 more)
...
Cohesion: 0.15
Nodes (3): EMPTY, HubShiftUtil, VirtualPD
...
Cohesion: 0.16
Nodes (11): seedRuntimeMissing(), seedRuntimeRunning(), cookie, snapshot, console, cookie, makeScriptedRunCommandFactory(), body (+3 more)

### Community 180 - "Community 180"
Cohesion: 0.14
Nodes (15): commsToneFromConnections(), JoystickStatus, joystickToneFromStatus(), robotToneFromRunStatus(), StatusTile(), StatusTileProps, StatusTileRow(), StatusTileRowProps (+7 more)
...
Cohesion: 0.15
Nodes (17): 6. Backup and Restore, code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), code:bash (bun run backup), code:bash (bun run backup -- --output /path/to/backup) (+9 more)
...
Cohesion: 0.18
Nodes (7): dirExists(), main(), parseArgs(), runTar(), timestamp(), Vision, VisionConsumer
...
Cohesion: 0.22
Nodes (15): 11. Project Import, code:bash (bun run dev:control), code:bash (bun run migrate:status  # verify DB is accessible), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" \), code:bash (bun run measure), code:block44 (═══ CodeRunner — Resource Report ═══), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=3072m) (+7 more)
...
Cohesion: 0.25
Nodes (13): code:powershell (git submodule update --init --recursive), code:text (apps/control/                  Bun control plane with login,), code:text (apps/control/src/__tests__/        Bun tests: auth, runs, pr), CodeRunner, Commands, FRC Web Simulator, FRC Web Simulator V1, Layout (+5 more)
...
Cohesion: 0.29
Nodes (12): 7. Cache Cleanup, code:bash (bun run restore -- <backup-dir> --workspace ws_abc123...), code:bash (bun run docker:cleanup), code:bash (bun run docker:cleanup -- --dry-run), code:bash (rm -rf data/users/<workspaceId>/home/), code:bash (rm -rf data/users/<workspaceId>/logs/runs/*), code:bash (for dir in data/users/*/; do), Docker system cleanup (+4 more)
...
Cohesion: 0.18
Nodes (10): code:text (e2e/                                  NEW — root-level Playw), code:ts (import { defineConfig, devices } from "@playwright/test";), Context, Critical files / surfaces to touch, Directory layout, E2E Testing Plan — FRC Programming Training Simulator, Open implementation choices (deliberately deferred), Playwright config (sketch) (+2 more)
...
Cohesion: 0.24
Nodes (10): code:block47 (data/users/<workspaceId>/backups/import-<timestamp>.tar.gz  ), code:bash (# Find the backup path), code:bash (MAX_ACTIVE_CONTAINERS=10   # default), code:bash (# Read current cap), code:bash (# Latest entries), code:bash (# Remove entries older than 90 days (default)), Configuration, Retention and pruning (+2 more)
...
Cohesion: 0.5
Nodes (4): code:json ("e2e": "E2E_TEST=1 playwright test --project=mocked",), code:bash (bun install), code:bash (bun run e2e              # mocked tier; globalSetup rebuilds), How to run (local-only for now)
...
## Knowledge Gaps
- **3723 isolated node(s):** `nosniff`, `cookie`, `console`, `consoleErrors`, `leaseErrors` (+3718 more)
...
- **Why does `Robot` connect `Community 88` to `Community 0`, `Community 1`, `Community 100`, `Community 146`, `Community 58`, `Community 27`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 58` to `Community 24`, `Community 74`, `Community 19`, `Community 12`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `isWorkspaceSlug()` connect `Community 59` to `Community 91`, `Community 21`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **What connects `nosniff`, `cookie`, `console` to the rest of the system?**
  _3723 weakly-connected nodes found - possible documentation gaps or missing edges._

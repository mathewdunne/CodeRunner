...
## Corpus Check
- 1067 files · ~734,605 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9148 nodes · 11567 edges · 1130 communities (720 shown, 410 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 281 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `95f450df`
...
## Communities (1130 total, 410 thin omitted)
...
Cohesion: 0.02
Nodes (32): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+24 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (92): AdminActionResponse, adminActionResponseSchema, AdminStatusResponse, adminStatusResponseSchema, AdminWorkspaceStatus, adminWorkspaceStatusSchema, AllianceStation, allianceStationSchema (+84 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (77): ControlAppOptions, createApp(), DockerCommandResult, adminCookie, body, fakeDocker, rows, student (+69 more)
...
Cohesion: 0.06
Nodes (35): EMPTY, SubsystemFactory, applyAdvantageScopePatches(), ascopeRoot, CommandResult, patchDir, patchFiles(), repoRoot (+27 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (50): apiErrorResponse(), AppSocket, AssetManifest, authFromRequest(), autoChoosersSnapshot(), BunUpgradeServer, capacityErrorResponse(), containersStatusResponse() (+42 more)
...
Cohesion: 0.04
Nodes (3): Command, DriveDistance, ExampleCommand

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (49): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.22.2, 0.22.4, 0.27.0, 0.30.0, 0.30.1, 0.31.0 (+41 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (49): 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.19.0 - 2019-05-31, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21 (+41 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (30): RunControls(), RunControlsProps, pillVariant(), StatusStrip(), StatusStripProps, TopbarProps, AutoPanel(), AutoPanelProps (+22 more)
...
Cohesion: 0.04
Nodes (48): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.1.0 - 2017-09-27, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.33.1 - 2021-04-30, 0.3.1 - 2017-11-17 (+40 more)
...
Cohesion: 0.09
Nodes (26): IDELayout(), IDELayoutProps, InitialsAvatar(), UserMenuProps, DriverStation(), MatchTimer(), MatchTimerProps, STATION_LABELS (+18 more)
...
Cohesion: 0.06
Nodes (4): ReplaceMeSubsystem, SubsystemBase, SubsystemBase(), Shooter
...
Cohesion: 0.1
Nodes (19): EditorPane(), EditorPaneProps, ScopePane, ScopePaneProps, Topbar(), useAutoChoosers(), UseAutoChoosersReturn, useContainerStatus() (+11 more)
...
Cohesion: 0.07
Nodes (29): 0.10.1, 0.23.4, 0.23.6, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2 (+21 more)
...
Cohesion: 0.11
Nodes (14): RunCommandFactory, announceChooser(), controlled, cookie, encodeMsgPack(), fakeDocker, FakeWebSocket, messages (+6 more)
...
Cohesion: 0.13
Nodes (3): DoubleSupplier, ArcadeDriveCommand(), Drive
...
Cohesion: 0.18
Nodes (15): 5. Configuration, code:bash (bun run measure), code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m) (+7 more)
...
Cohesion: 0.21
Nodes (11): IconRail(), IconRailButton(), IconRailButtonProps, IconRailProps, RailTab, SimControls(), SimControlsProps, Tooltip() (+3 more)
...
Cohesion: 0.25
Nodes (3): GyroIONavX, GyroIOSim, GyroIO
...
Cohesion: 0.33
Nodes (4): code:java (int i;), code:java (int i = switch(j) {), Java Clean Ups, `switchExpression`
...
## Knowledge Gaps
- **3813 isolated node(s):** `workspaceSlugSchema`, `userIdSchema`, `workspaceIdSchema`, `displayNameSchema`, `workspaceRouteSchema` (+3808 more)
...
- **Why does `Robot` connect `Community 42` to `Community 8`, `Community 3`, `Community 29`, `Community 22`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 35` to `Community 9`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `isWorkspaceSlug()` connect `Community 40` to `Community 4`?**

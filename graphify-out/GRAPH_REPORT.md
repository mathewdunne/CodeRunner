...
## Corpus Check
- 5055 files · ~3,590,561 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14149 nodes · 24666 edges · 1477 communities (952 shown, 525 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 374 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `25042a8c`
...
## Communities (1477 total, 525 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (42): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+34 more)
...
Cohesion: 0.03
Nodes (229): AuthenticationGetSessionOptions, AuthenticationProvider, AuthenticationProviderAuthenticationSessionsChangeEvent, AuthenticationProviderInformation, AuthenticationSessionAccountInformation, BranchCoverage, BreakpointsChangeEvent, CallHierarchyItem (+221 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (229): AccessibilityInformation, AuthenticationForceNewSessionOptions, AuthenticationProviderOptions, AuthenticationSession, AuthenticationSessionsChangeEvent, AutoClosingPair, Breakpoint, CallHierarchyIncomingCall (+221 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (6): Command, DriveDistance, TurnTime, m_autoTime(), RapidReactCommandBot, SysIdRoutineBot
...
Cohesion: 0.03
Nodes (96): getSessionFromRequest(), isAllowedWebSocketOrigin(), isLoopbackHost(), normalizeHost(), requireAdmin(), requireSession(), requireWebSocketOrigin(), requireWorkspaceOwnership() (+88 more)
...
Cohesion: 0.06
Nodes (35): codeContainerName(), CodeContainerStatus, containerName(), ContainerOrchestrator, ContainerOrchestratorOptions, containerRuntimeState(), defaultDockerRunner(), DockerCommandResult (+27 more)
...
Cohesion: 0.04
Nodes (9): DoubleSupplier, ExtensionIOSpark, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, SpindexerIOSpark, Drive, TurretIOSpark (+1 more)
...
Cohesion: 0.05
Nodes (47): RunControls(), RunControlsProps, pillVariant(), StatusStrip(), StatusStripProps, TopbarProps, AutoPanel(), AutoPanelProps (+39 more)
...
Cohesion: 0.04
Nodes (8): WaitUntilHopperIsEmptyCommand, ExtensionIO, IntakeCommand, IntakeControlCommand, IntakeSubsystem, RollerIOSim, RollerIO, SimShotVisualizer
...
Cohesion: 0.04
Nodes (45): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.4, 0.27.0, 0.30.0, 0.30.1, 0.31.0 (+37 more)

### Community 32 - "Community 32"
Cohesion: 0.08
Nodes (28): EMPTY, applyAdvantageScopePatches(), ascopeRoot, CommandResult, patchDir, patchFiles(), repoRoot, run() (+20 more)

### Community 33 - "Community 33"
Cohesion: 0.04
Nodes (44): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+36 more)

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (44): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+36 more)

### Community 35 - "Community 35"
Cohesion: 0.06
Nodes (35): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, BigButton(), BigButtonProps, EnableDisableRow(), EnableDisableRowProps (+27 more)

### Community 36 - "Community 36"
Cohesion: 0.07
Nodes (30): EditorPane(), EditorPaneProps, ScopePane, ScopePaneProps, Topbar(), useAutoChoosers(), UseAutoChoosersReturn, useContainerStatus() (+22 more)
...
Cohesion: 0.06
Nodes (24): BINDING_GROUPS, Bumper(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer(), SmallButton(), StatusTone (+16 more)
...
Cohesion: 0.08
Nodes (25): ConsolePane(), ConsolePaneProps, CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun(), ConsoleLine(), ConsolePanel() (+17 more)
...
Cohesion: 0.06
Nodes (8): ModuleIOTalonFX, IndexerIOSim, IndexerIOTalonFX, IndexerIO, ModuleIO, TurretIO, VisionIO, VisionIOPhotonVision
...
Cohesion: 0.11
Nodes (4): AllianceFlipUtil, getPose(), OverrideUtil, ShootingLocation()
...
Cohesion: 0.14
Nodes (23): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (bun run measure), code:bash (bun run measure -- --json), code:bash (# All managed containers), code:bash (# Container is auto-recreated on next run. If persistent:) (+15 more)
...
Cohesion: 0.1
Nodes (4): GyroIOPigeon2, PhoenixOdometryThread, GyroIO, PhoenixUtil
...
Cohesion: 0.17
Nodes (20): 13. Audit Log, 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 7. Cache Cleanup, 8. Monitoring, Between class sessions, code:bash (# Latest entries) (+12 more)
...
Cohesion: 0.19
Nodes (14): After, Before, code:java (public class Foo {), code:java (public class Bar {), Examples, Rename, dirExists(), fileExists() (+6 more)
...
Cohesion: 0.18
Nodes (15): Admin status API, code:bash (bun run restore -- <backup-dir> --dry-run), code:bash (bun run restore -- <backup-dir> --workspace ws_abc123...), code:bash (bun run docker:cleanup), code:bash (bun run docker:cleanup -- --dry-run), code:bash (rm -rf data/users/<workspaceId>/home/), code:bash (rm -rf data/users/<workspaceId>/logs/runs/*), code:bash (for dir in data/users/*/; do) (+7 more)
...
Cohesion: 0.21
Nodes (13): 5. Configuration, code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), Environment variables (+5 more)
...
Cohesion: 0.24
Nodes (10): commsToneFromConnections(), JoystickStatus, joystickToneFromStatus(), robotToneFromRunStatus(), StatusTile(), StatusTileProps, StatusTileRow(), StatusTileRowProps (+2 more)
...
Cohesion: 0.28
Nodes (9): 6. Backup and Restore, code:bash (CODE_MEMORY_LIMIT=2560m), code:bash (bun run backup), code:bash (bun run backup -- --output /path/to/backup), code:bash (bun run restore -- <backup-dir>), Create a backup, Recommended backup schedule, Restore from backup (+1 more)
...
Cohesion: 0.29
Nodes (4): MODE_CLASSES, MODE_LABELS, ModeColumn(), ModeColumnProps
...
Cohesion: 0.67
Nodes (3): code:bash (# Step 1: Find the Java process ID), code:block27 (Found one Java-level deadlock:), Getting Detailed JVM Thread States (Using jstack)
...
## Knowledge Gaps
- **3364 isolated node(s):** `workspaceSlugSchema`, `userIdSchema`, `workspaceIdSchema`, `displayNameSchema`, `workspaceRouteSchema` (+3359 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **525 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 51` to `Community 0`, `Community 32`, `Community 43`, `Community 22`, `Community 603`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 57` to `Community 10`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 112` to `Community 22`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **What connects `workspaceSlugSchema`, `userIdSchema`, `workspaceIdSchema` to the rest of the system?**
  _3364 weakly-connected nodes found - possible documentation gaps or missing edges._

...
## Corpus Check
- 152 files · ~94,591 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2106 nodes · 2768 edges · 177 communities (166 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a55c9c52`
...
6. `FRC Web Simulator V2: Design Document` - 20 edges
7. `FRC Web Simulator V2: Design Document` - 20 edges
8. `Robot` - 17 edges
9. `RobotContainer` - 15 edges
10. `Main` - 15 edges
...
Cohesion: 0.23
Nodes (11): 1. Prerequisites, 8. Monitoring, Admin status API, code:bash (curl http://localhost:4000/admin/status | jq .), code:bash (# All managed containers), Docker container status, FRC Web Simulator V1 — Operator Runbook, FRC Web Simulator V2 — Operator Runbook (+3 more)
...
Cohesion: 0.22
Nodes (9): 10. Host Sizing, code:bash (bun run measure), code:block39 (═══ FRC Web Simulator — Resource Report ═══), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=3072m), Measuring actual usage, Per-student resource usage, Sizing recommendations (+1 more)
...
Cohesion: 0.33
Nodes (6): 5. Configuration, code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), Key settings for classroom use, Tuning for constrained hosts, Tuning for large classrooms
...
Cohesion: 0.67
Nodes (3): code:bash (bun run measure), code:bash (bun run measure -- --json), Resource measurement

## Knowledge Gaps
- **969 isolated node(s):** `workspaceSlugSchema`, `userIdSchema`, `workspaceIdSchema`, `sessionIdSchema`, `displayNameSchema` (+964 more)
...
- **Why does `isWorkspaceSlug()` connect `Community 9` to `Community 74`, `Community 6`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 16` to `Community 10`, `Community 68`?**

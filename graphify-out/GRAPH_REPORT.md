# Graph Report - CodeRunner  (2026-05-27)

## Corpus Check
- 1760 files · ~1,505,212 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18015 nodes · 33882 edges · 1808 communities (1250 shown, 558 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 393 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `738cc65d`
...
1. `main()` - 594 edges
2. `Robot()` - 533 edges
3. `TeleopPeriodic()` - 207 edges
4. `RobotPeriodic()` - 198 edges
5. `Change Log` - 174 edges
6. `DisabledInit()` - 171 edges
7. `TeleopInit()` - 171 edges
8. `AutonomousInit()` - 153 edges
9. `AutonomousPeriodic()` - 153 edges
10. `TestPeriodic()` - 153 edges

## Surprising Connections (you probably didn't know these)
- `saveAllowlist()` --calls--> `Rename`  [INFERRED]
  apps/control/src/auth/allowlist.ts → data/users/ws_edbea982207dfd8afec0a80eed032197/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `restoreProjectArchive()` --calls--> `Rename`  [INFERRED]
  apps/control/src/app/archive-utils.ts → data/users/ws_edbea982207dfd8afec0a80eed032197/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `restoreArchive()` --calls--> `Rename`  [INFERRED]
  scripts/restore.ts → data/users/ws_edbea982207dfd8afec0a80eed032197/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `restoreProjectArchive()` --calls--> `Rename`  [INFERRED]
  apps/control/src/app.ts → data/users/ws_edbea982207dfd8afec0a80eed032197/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `timestamp()` --calls--> `pad()`  [INFERRED]
  scripts/backup.ts → apps/control/src/logging.ts
...
## Communities (1808 total, 558 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.0
Nodes (52): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+44 more)
...
Cohesion: 0.01
Nodes (6): Command, DriveToPoseCommand, TurnDegrees, TurnTime, m_autoTime(), SysIdRoutineBot
...
Cohesion: 0.02
Nodes (171): ascopeRoot, assert(), createTemplate(), distDir, exists(), patchDir, repoRoot, runGit() (+163 more)
...
Cohesion: 0.02
Nodes (6): AutonomousDistance, AutonomousTime, ComplexAuto, DriveToClimbPoseSequentialCommand, SequentialCommandGroup, ReplaceMeSequentialCommandGroup

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (114): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+106 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (12): Main, Main, Main, Main, Main, RobotBase, Main, Main (+4 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (36): codeContainerName(), containerName(), ContainerOrchestrator, ContainerOrchestratorOptions, containerRuntimeState(), defaultDockerRunner(), dockerError(), DockerInspectContainer (+28 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (77): body, body, body, body, absolute, refs, headers, received (+69 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (14): DoubleSupplier, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand, SpindexerIOSpark, ArcadeDriveCommand(), Drive (+6 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (94): handleUploadAsset(), userAssetsPath(), getDemoSessionResponseBody(), seedDemoUser(), requireSession(), input, stripped, apiError() (+86 more)
...
Cohesion: 0.02
Nodes (102): first, NUM_RUNS, parsed, slugArb, AdminActionResponse, adminActionResponseSchema, AdminStatusResponse, adminStatusResponseSchema (+94 more)
...
Cohesion: 0.05
Nodes (55): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), defaultDockerRunner(), dockerError(), dockerPortBindError(), inspectContainer() (+47 more)
...
Cohesion: 0.03
Nodes (79): ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange, loadControlConfig() (+71 more)

### Community 24 - "Community 24"
Cohesion: 0.04
Nodes (7): SetBrakeModeCommand, InstantCommand, ReplaceMeInstantCommand, RobotContainer, ReplaceMeParallelDeadlineGroup, RobotContainer, RobotContainer
...
Cohesion: 0.05
Nodes (39): activeWorkspaces, DockerStatsPoller, DockerStatsPollerOptions, log, containerCpuPercent, containerMemoryPercent, containerStartBuckets, containerStartDuration (+31 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (43): DEFAULT_PORT, GamepadLease, GamepadLeaseResolver, GamepadMessageOutcome, GamepadSessions, GamepadStatus, halsimTarget(), log (+35 more)
...
Cohesion: 0.04
Nodes (7): AutoCloseable, Arm, LoadPreferences(), ReachSetpoint(), SimulationPeriodic(), Stop(), Intake
...
Cohesion: 0.04
Nodes (4): Robot, Robot, Robot, LoggedRobot

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (5): OuttakeCommand, IntakeCommand, IntakeControlCommand, ShootIfReadyCommand, SimShotVisualizer

### Community 36 - "Community 36"
Cohesion: 0.05
Nodes (40): DemoBanner(), EditorPane(), EditorPaneProps, ScopePane, ScopePaneProps, Topbar(), patchCall, { result } (+32 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (10): RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, ShootUntilHopperEmptyCommand (+2 more)
...
Cohesion: 0.05
Nodes (51): 1. Find your host IP, 1. Login And Isolation, 2. Editor And Project Persistence, 2. Start the control plane, 3. Connect from other machines, 3. File Operations, 4. Firewall (if needed), 4. Java IDE Features (+43 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (43): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21 (+35 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (43): 0.12.2 - 2018-9-6, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+35 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (7): HopperSubsystem, KickerIOSim, KickerIO, SpindexerIOSim, SpindexerIO, VisionConsumer, VisionSubsystem

### Community 43 - "Community 43"
Cohesion: 0.04
Nodes (41): 0.18.2 - 2019-07-23, 0.22.4, 0.27.0, 0.30.1, 0.31.0, 0.31.3, 0.35.1, 0.37.1 (+33 more)

### Community 44 - "Community 44"
Cohesion: 0.04
Nodes (47): 0.18.2 - 2019-07-23, 0.22.2, 0.22.4, 0.27.0, 0.30.0, 0.30.1, 0.31.0, 0.31.1 (+39 more)
...
Cohesion: 0.09
Nodes (29): AdminApp(), AdminLayout(), Tab, tabs, useAdminPoll(), Allowlist(), AllowlistData, AuditEntry (+21 more)

### Community 49 - "Community 49"
Cohesion: 0.12
Nodes (6): Elevator, ReachGoal(), Reset(), SimulationPeriodic(), Stop(), UpdateTelemetry()

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (31): IDELayout(), IDELayoutProps, Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimer(), MatchTimerProps (+23 more)
...
Cohesion: 0.05
Nodes (3): ExampleGlobalMeasurementSensor, ExampleGlobalMeasurementSensor, ChassisTrapezoidalController

### Community 54 - "Community 54"
Cohesion: 0.07
Nodes (27): AutoPanel(), AutoPanelProps, ControlsPanel(), ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES (+19 more)

### Community 55 - "Community 55"
Cohesion: 0.06
Nodes (3): TrenchDuckCommand, TurretCommands, LaunchCalculator

### Community 56 - "Community 56"
Cohesion: 0.05
Nodes (6): ModuleIO, RobotContainer, TurretIO, VisionIOPhotonVisionSim, VisionIO, VisionIOPhotonVision
...
Cohesion: 0.07
Nodes (30): ConsolePane(), ConsolePaneProps, CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun(), ConsoleLine(), ConsolePanel() (+22 more)
...
Cohesion: 0.07
Nodes (3): DriveCommands, WheelRadiusCharacterizationState, TunableDouble
...
Cohesion: 0.07
Nodes (12): bashCalls, cloneCall, ctx, importer, mock, row, workspace, ImportContext (+4 more)

### Community 72 - "Community 72"
Cohesion: 0.1
Nodes (3): FlywheelIO, HoodIO, ShooterSubsystem

### Community 73 - "Community 73"
Cohesion: 0.09
Nodes (25): RunControls(), RunControlsProps, pillVariant(), StatusStrip(), StatusStripProps, TopbarProps, MODE_CLASSES, MODE_LABELS (+17 more)
...
Cohesion: 0.09
Nodes (30): addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist() (+22 more)
...
Cohesion: 0.05
Nodes (28): 0.10.0, 0.11.0, 0.11.1, 0.11.2, 0.11.3, 0.12.0, 0.12.1, 0.13.0 (+20 more)
...
Cohesion: 0.08
Nodes (3): AssistedDriveCommand, round, GeometryUtil

### Community 81 - "Community 81"
Cohesion: 0.06
Nodes (36): admin/allowlist-management.spec.ts, admin/audit-log.spec.ts, admin/capacity-cap.spec.ts, admin/user-management.spec.ts, auth/allowlist.spec.ts, auth/login.spec.ts, auth/roles.spec.ts, auth/session-isolation.spec.ts (+28 more)
...
Cohesion: 0.11
Nodes (20): chooserRoots(), decodeMsgPack(), displayKey(), encodeMsgPack(), isChooser(), normalizeTopicName(), Nt4AutoChooserBridge, Nt4AutoChooserBridgeOptions (+12 more)
...
Cohesion: 0.15
Nodes (31): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token), code:alloy (prometheus.scrape "control_plane" {) (+23 more)
...
Cohesion: 0.08
Nodes (18): ResolvedTheme, Theme, THEME_VALUES, ThemeProvider(), ThemeProviderContext, ThemeProviderProps, ThemeProviderState, useTheme() (+10 more)
...
Cohesion: 0.07
Nodes (26): 0.10.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+18 more)

### Community 98 - "Community 98"
Cohesion: 0.07
Nodes (29): 0.10.1, 0.19.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+21 more)

### Community 99 - "Community 99"
Cohesion: 0.1
Nodes (4): ExtensionIO, IntakeSubsystem, RollerIOSim, RollerIO
...
Cohesion: 0.07
Nodes (23): 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1, 0.26.2 (+15 more)
...
Cohesion: 0.11
Nodes (26): code:powershell (git submodule update --init --recursive), code:powershell (git submodule update --init --recursive), code:text (apps/control/                  Bun control plane with login,), code:text (apps/control/src/__tests__/        Bun tests: auth, runs, pr), CodeRunner, Commands, Layout, Observability (+18 more)
...
Cohesion: 0.08
Nodes (15): Activation, Anti-patterns (Avoid these), Common Workflows, Fallback, Java LSP Tools, `lsp_java_findSymbol`, `lsp_java_getCallHierarchy`, `lsp_java_getFileImports` (+7 more)
...
Cohesion: 0.11
Nodes (7): Listener, FakeWebSocket, setupBridgeAndSocket(), FakeWebSocket, announceChooser(), encodeMsgPack(), FakeWebSocket

### Community 130 - "Community 130"
Cohesion: 0.08
Nodes (7): Agent Capabilities, Feedback, Java Debug Agent, Limitations, Overview, Requirements, See Also
...
Cohesion: 0.14
Nodes (23): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 8. Monitoring (+15 more)
...
Cohesion: 0.13
Nodes (5): getAngularExitVelocity(), getHoodAngle(), getLinearExitVelocity(), TurretCalculator, TurretVisualizer
...
Cohesion: 0.16
Nodes (3): Initialize(), IsFinished(), ReleaseHatch
...
Cohesion: 0.12
Nodes (22): 2.1 Clone and initialize, 2.2 Build container images, 2.2 Build the code container image, 2.3 Build web assets, 2.4 Configure environment, 2.5 Run migrations, 2.6 Verify the setup, 2.7 Measure host resources (+14 more)
...
Cohesion: 0.09
Nodes (21): 0.4.5, 0.4.6, 0.5.0, 0.5.3, 0.5.4, 0.5.5, 0.5.6, 0.5.7 (+13 more)

### Community 166 - "Community 166"
Cohesion: 0.25
Nodes (20): ascopeLiteStatic, ascopeRoot, compileLite(), compileWasm(), distDir, ensureEmscripten(), ensureSubmodule(), envWithEmsdk() (+12 more)
...
Cohesion: 0.1
Nodes (20): Architecture, Auth: Better Auth test-utils, gated by env, code:text (e2e/                                  NEW — root-level Playw), code:json ("e2e": "E2E_TEST=1 playwright test --project=mocked",), code:bash (bun install), code:bash (bun run e2e              # mocked tier; globalSetup rebuilds), code:ts (import { defineConfig, devices } from "@playwright/test";), Context (+12 more)
...
Cohesion: 0.15
Nodes (3): Fuel, Hub, SimIntake

### Community 193 - "Community 193"
Cohesion: 0.14
Nodes (13): GamepadFrame, GamepadInfo, listConnectedGamepads(), makeLabel(), FakePad, { result }, UseGamepadResult, dpadToPov() (+5 more)
...
Cohesion: 0.16
Nodes (18): Bind mounts, Build, code:bash (bun run docker:build:code), code:block2 (frc-sim.managed=true), code:bash (docker run -d \), code:bash (docker run -d \), Environment variables, Example run (+10 more)
...
Cohesion: 0.16
Nodes (10): Args, backupDatabase(), dirExists(), fileExists(), main(), parseArgs(), runTar(), timestamp() (+2 more)
...
Cohesion: 0.22
Nodes (18): 7. Cache Cleanup, Admin status API, code:bash (# on the laptop, after stopping local dev), code:bash (bun run docker:cleanup), code:bash (bun run docker:cleanup -- --dry-run), code:bash (rm -rf data/users/<workspaceId>/home/), code:bash (rm -rf data/users/<workspaceId>/logs/runs/*), code:bash (for dir in data/users/*/; do) (+10 more)

### Community 223 - "Community 223"
Cohesion: 0.2
Nodes (18): 11. Project Import, code:bash (docker stats --filter label=frc-sim.managed=true --no-stream), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=3072m), code:block49 (data/users/<workspaceId>/backups/import-<timestamp>.tar.gz  ), code:bash (# Find the backup path), code:bash (MAX_ACTIVE_CONTAINERS=10   # default), code:bash (# Read current cap) (+10 more)
...
Cohesion: 0.12
Nodes (17): 1. GCP project, 2. Terraform state bucket, 3. Configure Terraform vars, 4. Apply, 5. Populate Secret Manager, 6. DNS, 7. Re-render config on the VM, 8. Configure GitHub repo for the deploy workflow (+9 more)
...
Cohesion: 0.12
Nodes (16): caches/8.11/transforms (~2.1 GB/workspace), code:block1 (5.3G  total workspace), Combined impact, Constraints from the original plan (still apply), Files to touch, Findings, Goal, Handoff: Shared Gradle Cache for `coderunner-workspace` (+8 more)

### Community 245 - "Community 245"
Cohesion: 0.15
Nodes (14): commsToneFromConnections(), JoystickStatus, joystickToneFromStatus(), robotToneFromRunStatus(), StatusTile(), StatusTileProps, StatusTileRow(), StatusTileRowProps (+6 more)
...
Cohesion: 0.55
Nodes (6): Autonomous(), Disabled(), EndCompetition(), StartCompetition(), Teleop(), Test()
...
Cohesion: 0.17
Nodes (15): 5. Configuration, code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m) (+7 more)
...
Cohesion: 0.15
Nodes (14): Architecture at runtime, Changing control-plane env vars, code:block1 (internet ──443──> Caddy (VM) ──:4000──> bun control plane (s), code:bash (sudo /opt/coderunner/render-env.sh && sudo systemctl restart), code:bash (gh workflow run "Deploy to GCE" --ref main -f tag=v2.3.0), code:bash (printf '<new value>' | gcloud secrets versions add coderunne), CodeRunner GCE Deployment, Cost notes (+6 more)
...
Cohesion: 0.14
Nodes (13): 026 — Gradle Cache Deduplication via Image Seed, Change 1: Host-side hard-link seed (attempted, rolled back), Change 2: Eliminate `permwrapper` duplication (shipped), Change 3: Expand seed to cover common vendor lib transforms (shipped), code:block1 (3.6 GB  data/users/<id>/home/.gradle/), Consequences, Context, Decision (+5 more)

### Community 308 - "Community 308"
Cohesion: 0.14
Nodes (14): code:text (e2e/                                  NEW — root-level Playw), code:json ("e2e": "E2E_TEST=1 playwright test --project=mocked",), code:bash (bun install), code:bash (bun run e2e              # mocked tier; globalSetup rebuilds), code:ts (import { defineConfig, devices } from "@playwright/test";), Context, Critical files / surfaces to touch, Directory layout (+6 more)

### Community 309 - "Community 309"
Cohesion: 0.14
Nodes (3): IndexerIOSim, IndexerIOTalonFX, IndexerIO
...
Cohesion: 0.28
Nodes (3): getPose(), OverrideUtil, ShootingLocation()
...
Cohesion: 0.21
Nodes (3): FakeSocket, { result }, { unmount }
...
Cohesion: 0.24
Nodes (11): 6. Backup and Restore, code:bash (bun run backup), code:block19 (data/backups/2026-05-16-151038/), code:bash (bun run backup -- --output /path/to/backup     # custom outp), code:bash (bun run restore -- <backup-dir>), code:bash (bun run restore -- <backup-dir> --dry-run                   ), Create a backup, Local-dev → VM migration (+3 more)
...
Cohesion: 0.18
Nodes (11): 1. Add an A record at your registrar, 2. Update Caddyfile on the existing VM, 3. Bootstrap deploy (creates the CF Pages project), 4. Set BACKEND_ORIGIN as a Pages secret, 5. Add the custom domain, 6. Configure GitHub Actions, code:bash (gcloud compute ssh coderunner --zone=us-central1-a --tunnel-), code:bash (bun run build:web) (+3 more)
...
Cohesion: 0.18
Nodes (3): GyroIOPigeon2, GyroIOSim, GyroIO
...
Cohesion: 0.2
Nodes (9): code:ts (export class WorkspacePage {), `e2e/fixtures/app.ts` — control plane fixture, `e2e/fixtures/auth.ts` — Better Auth test-utils helpers, `e2e/fixtures/fake-halsim.ts`, `e2e/fixtures/fake-vscode.ts`, `e2e/fixtures/runtime.ts`, Page objects, Test data conventions (+1 more)
...
Cohesion: 0.22
Nodes (9): code:block2 (I'm getting NPE when calling userService.getUser()), code:block3 (The calculateTotal() method returns wrong value), code:block4 (Debug processOrder with orderId=456), code:block5 (I suspect a race condition in the worker threads), Debug a NullPointerException, Debug Multi-threaded Issues, Debug with Specific Input, Debug Wrong Calculation Result (+1 more)
...
Cohesion: 0.22
Nodes (9): code:bash (bun test apps/control/src/__tests__/security      # unit-lev), code:bash (bun test apps/control/src/__tests__/property       # ~5 sec,), code:text (apps/web/src/hooks/useRunChannel.test.ts), code:bash (bun run --cwd apps/web test            # watch mode), Companion test layers (beyond E2E), Frontend unit and component tests, Property and fuzz tests, Security tests (+1 more)
...
Cohesion: 0.25
Nodes (8): 6.1 IDs, 6.2 SQLite changes, 6.3 Filesystem layout, 6. Domain Model Changes, code:block2 (coderunner-workspace-<workspaceId>), code:block3 (frc-sim.managed=true), code:block4 (-- 004_v2_code_container.sql), code:block5 (data/)
...
Cohesion: 0.25
Nodes (7): Consequences, Context, Decision, Decision 022: Skip Docker smoke tier and import/backup-restore E2E tests, Docker smoke tier — not implemented, Import and backup/restore tests — deferred, Status
...
Cohesion: 0.25
Nodes (8): Be Specific, code:block7 (✅ Good: "Why does getUserById return null when id=123?"), code:block8 (✅ Good: "Getting ArrayIndexOutOfBoundsException in processIt), code:block9 (✅ Good: "The order total is $0 instead of $150 for order 456), Mention the Error, Provide Context, Stay in Agent Mode, Tips for Best Results
...
Cohesion: 0.25
Nodes (7): CodeRabbit: AI code reviews in your editor, ❓ Frequently Asked Questions, 🏁 Getting Started, 🔄 Integrations, 🚀 Key Features, 🤖Supported coding agents, ✨ Why CodeRabbit

### Community 561 - "Community 561"
Cohesion: 0.32
Nodes (7): applyAdvantageScopePatches(), ascopeRoot, CommandResult, patchDir, patchFiles(), repoRoot, run()
...
Cohesion: 0.33
Nodes (6): After, Before, code:java (public class Foo {), code:java (public class Bar {), Examples, Rename
...
Cohesion: 0.33
Nodes (6): 1. Open Copilot Chat, 2. Switch to JavaDebug Agent Mode, 3. Enter Your Debugging Request, 4. Let the Agent Work, code:block1 (Why am I getting a NullPointerException in OrderService?), Getting Started
...
Cohesion: 0.33
Nodes (6): Architecture, Auth: Better Auth test-utils, gated by env, Port allocation and `baseURL` coupling, Single server in tests (matches production topology, in-process), Two-tier strategy, WebSocket coverage philosophy
...
Cohesion: 0.4
Nodes (5): code:bash (gh workflow run "Deploy to GCE" --ref main -f tag=v2.4.0), code:block13 (student browser ──443──> Cloudflare Pages (coderunner)), code:block19 (deploy/), Files, How it works

### Community 662 - "Community 662"
Cohesion: 0.4
Nodes (5): Cloudflare Pages mode, code:bash (gh workflow run "Deploy to GCE" --ref main -f tag=v2.5.0), Ongoing releases, Rollback, Rollback
...
Cohesion: 0.4
Nodes (5): 2.2 Check Session State (Call ONCE, Then Act!), code:block5 (vscjava.vscode-java-debug/getDebugSessionInfo()), code:block6 (═══════════════════════════════════════════), code:block7 (═══════════════════════════════════════════), code:block8 (❌ No active debug session found.)
...
Cohesion: 0.5
Nodes (4): Agent Can't Find the File, Breakpoint Not Hit, Debug Session Won't Start, Troubleshooting
...
Cohesion: 0.67
Nodes (3): 0.11.1, Fixes, Improvements

### Community 1089 - "Community 1089"
Cohesion: 0.67
Nodes (3): 0.8.2, Fixes, Improvements

### Community 1090 - "Community 1090"
Cohesion: 0.67
Nodes (3): 0.7.9, Fixes, Improvements

### Community 1091 - "Community 1091"
Cohesion: 0.67
Nodes (3): 0.7.8, Fixes, Improvements

### Community 1092 - "Community 1092"
Cohesion: 0.67
Nodes (3): 0.8.1, Fixes, Improvements

### Community 1093 - "Community 1093"
Cohesion: 0.67
Nodes (3): 0.14.3, Fixes, Improvements

### Community 1094 - "Community 1094"
Cohesion: 0.67
Nodes (3): 0.16.0, Additions, Fixes(Breaking)

## Knowledge Gaps
- **4170 isolated node(s):** `nosniff`, `cookie`, `console`, `consoleErrors`, `leaseErrors` (+4165 more)
...
- **Why does `Robot` connect `Community 86` to `Community 0`, `Community 34`, `Community 35`, `Community 103`, `Community 84`, `Community 213`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 27` to `Community 16`, `Community 10`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `Constants` connect `Community 147` to `Community 35`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **What connects `nosniff`, `cookie`, `console` to the rest of the system?**

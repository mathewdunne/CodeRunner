...
## Corpus Check
- 5208 files · ~3,644,314 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15161 nodes · 26662 edges · 1565 communities (1008 shown, 557 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 391 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `aa096fc2`
...
## Communities (1565 total, 557 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (44): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+36 more)
...
Cohesion: 0.01
Nodes (7): Command, DriveTime, DriveToPoseCommand, ExampleCommand, m_autoTime(), RapidReactCommandBot, SysIdRoutineBot

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (229): AccessibilityInformation, AuthenticationForceNewSessionOptions, AuthenticationSession, BranchCoverage, CancellationError, CancellationToken, CancellationTokenSource, ChatPromptReference (+221 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (229): AuthenticationGetSessionOptions, AuthenticationProvider, AuthenticationProviderAuthenticationSessionsChangeEvent, AuthenticationProviderInformation, AuthenticationProviderOptions, AuthenticationSessionAccountInformation, AuthenticationSessionsChangeEvent, AutoClosingPair (+221 more)
...
Cohesion: 0.02
Nodes (147): createWebSocketHandlers(), ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp() (+139 more)
...
Cohesion: 0.02
Nodes (7): AutonomousDistance, AutonomousTime, ComplexAuto, DriveToClimbPoseSequentialCommand, SequentialCommandGroup, ReplaceMeSequentialCommandGroup, AgitateIntakeCommand
...
Cohesion: 0.04
Nodes (58): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), defaultDockerRunner(), dockerError(), dockerPortBindError(), inspectContainer() (+50 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (80): webShellResponse(), halsimWebSocketResponse(), HOP_BY_HOP_HEADERS, log, nt4AliveResponse(), nt4WebSocketResponse(), probeVscodeReady(), requestedProtocols() (+72 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (10): DoubleSupplier, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand, SpindexerIOSpark, Drive, TurretIOSpark (+2 more)
...
Cohesion: 0.04
Nodes (66): Auth, AuthCallbacks, createAuth(), log, slugFromEmail(), buildSocialProviders(), getEnabledAuthProviders(), OAuthProvider (+58 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (8): Main, Main, Main, Main, RobotBase, Main, Main, Main
...
Cohesion: 0.03
Nodes (6): WaitUntilHopperIsEmptyCommand, OuttakeCommand, IntakeCommand, IntakeControlCommand, ShootIfReadyCommand, SimShotVisualizer

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (49): EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip() (+41 more)
...
Cohesion: 0.05
Nodes (35): DEFAULT_PORT, GamepadLease, GamepadLeaseResolver, GamepadMessageOutcome, GamepadSessions, GamepadStatus, halsimTarget(), log (+27 more)
...
Cohesion: 0.06
Nodes (39): IDELayout(), IDELayoutProps, Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimer(), MatchTimerProps (+31 more)

### Community 31 - "Community 31"
Cohesion: 0.08
Nodes (47): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+39 more)
...
Cohesion: 0.06
Nodes (34): AutoPanel(), AutoPanelProps, ControlsPanel(), ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES (+26 more)
...
Cohesion: 0.04
Nodes (45): 0.22.4, 0.24.1, 0.30.0, 0.30.1, 0.31.0, 0.31.1, 0.31.3, 0.33.1 (+37 more)

### Community 39 - "Community 39"
Cohesion: 0.08
Nodes (12): AppStorage, ensureWorkspaceFiles(), log, LoginResult, nowIso(), randomId(), RunJobRow, RunJobState (+4 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (44): 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.32.0 - 2021-03-12, 0.32.1 - 2021-03-23 (+36 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (44): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.19.0 - 2019-05-31, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21 (+36 more)
...
Cohesion: 0.1
Nodes (44): completionItems(), completionItemsToSuggestions(), documentationToMarkdown(), handleDiagnostics(), hoverContentsToMarkdown(), hoverToMonaco(), initializeParams(), isCompletionItem() (+36 more)
...
Cohesion: 0.06
Nodes (35): activeWorkspaces, DockerStatsPoller, DockerStatsPollerOptions, log, containerCpuPercent, containerMemoryPercent, containerStartBuckets, containerStartDuration (+27 more)
...
Cohesion: 0.07
Nodes (7): RobotContainer, RobotContainer, RobotContainer, RobotContainer, ShootUntilHopperEmptyCommand, ShiftChangeRumbleLEDCommand, ParallelDeadlineGroup
...
Cohesion: 0.07
Nodes (17): Listener, { result }, { unmount }, FakeWebSocket, setupBridgeAndSocket(), bridge, enabledDisable, FakeWebSocket (+9 more)
...
Cohesion: 0.1
Nodes (22): ConsolePane(), ConsolePaneProps, CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun(), ConsoleLine(), ConsolePanel() (+14 more)
...
Cohesion: 0.07
Nodes (23): 0.23.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+15 more)
...
Cohesion: 0.07
Nodes (28): 0.18.5, 0.18.9, 0.23.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2 (+20 more)
...
Cohesion: 0.15
Nodes (24): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 6. Backup and Restore, 7. Cache Cleanup (+16 more)
...
Cohesion: 0.12
Nodes (11): bashCalls, cloneCall, ctx, importer, mock, row, workspace, ImportContext (+3 more)
...
Cohesion: 0.14
Nodes (13): seedRuntimeMissing(), seedRuntimeRunning(), cookie, snapshot, status, wsp, console, cookie (+5 more)
...
Cohesion: 0.13
Nodes (21): 5. Configuration, code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m) (+13 more)
...
Cohesion: 0.18
Nodes (19): 11. Project Import, code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=3072m), code:block46 (data/users/<workspaceId>/backups/import-<timestamp>.tar.gz  ), code:bash (# Find the backup path), code:bash (MAX_ACTIVE_CONTAINERS=10   # default), code:bash (# Read current cap), code:bash (# Latest entries) (+11 more)
...
Cohesion: 0.14
Nodes (5): ModuleIO, TurretIO, VisionIOPhotonVisionSim, VisionIO, VisionIOPhotonVision
...
Cohesion: 0.28
Nodes (12): Rename, Args, dirExists(), discoverWorkspaces(), fileExists(), main(), parseArgs(), restoreArchive() (+4 more)
...
Cohesion: 0.29
Nodes (5): patchCall, postCall, { result }, updatedStatus, VALID_STATUS
...
## Knowledge Gaps
- **3738 isolated node(s):** `nosniff`, `cookie`, `console`, `consoleErrors`, `leaseErrors` (+3733 more)
...
- **Why does `Robot` connect `Community 56` to `Community 0`, `Community 51`, `Community 21`, `Community 245`, `Community 667`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 94` to `Community 12`, `Community 53`, `Community 14`, `Community 31`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `isWorkspaceSlug()` connect `Community 59` to `Community 20`, `Community 85`?**

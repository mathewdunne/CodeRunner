...
## Corpus Check
- 117 files · ~82,143 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1618 nodes · 2308 edges · 123 communities (112 shown, 11 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d8e67d9d`
...
Cohesion: 0.06
Nodes (34): codeContainerName(), CodeContainerStatus, containerName(), ContainerOrchestrator, ContainerOrchestratorOptions, containerRuntimeState(), defaultDockerRunner(), DockerCommandResult (+26 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (36): ControlConfig, ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange, loadControlConfig() (+28 more)
...
Cohesion: 0.5
Nodes (4): code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), Stop containers too
...
- **Why does `port` connect `Community 9` to `Community 8`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `isWorkspaceSlug()` connect `Community 12` to `Community 49`, `Community 5`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `AppStorage` connect `Community 1` to `Community 0`, `Community 10`, `Community 11`, `Community 71`?**

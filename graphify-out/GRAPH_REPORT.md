...
## Corpus Check
- 1066 files · ~704,382 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9136 nodes · 11541 edges · 1146 communities (711 shown, 435 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 281 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cfb45b4a`
...
## Communities (1146 total, 435 thin omitted)
...
Cohesion: 0.02
Nodes (28): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+20 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (79): ControlAppOptions, createApp(), DockerCommandResult, DockerRunner, createStorage(), adminCookie, body, fakeDocker (+71 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (70): requireWebSocketOrigin(), apiError(), apiErrorResponse(), AppSocket, assertRealPathInside(), AssetManifest, authFromRequest(), autoChoosersSnapshot() (+62 more)
...
Cohesion: 0.08
Nodes (17): codeContainerName(), containerName(), ContainerOrchestrator, containerRuntimeState(), dockerPortBindError(), isLoopbackHost(), leaseContainerNameFor(), leasePortFor() (+9 more)
...
Cohesion: 0.06
Nodes (38): ConsolePane(), ConsolePaneProps, InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimer(), MatchTimerProps, STATION_LABELS (+30 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (4): WaitUntilHopperIsEmptyCommand, Command, ExampleCommand, TurnTime
...
Cohesion: 0.08
Nodes (30): EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip() (+22 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (49): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.0 (+41 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (49): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+41 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (49): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.19.0 - 2019-05-31, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+41 more)

### Community 17 - "Community 17"
Cohesion: 0.08
Nodes (28): EMPTY, SubsystemFactory, applyAdvantageScopePatches(), ascopeRoot, CommandResult, patchDir, patchFiles(), repoRoot (+20 more)
...
Cohesion: 0.09
Nodes (4): DefaultCommands, OperatorPanel, TurretCommands, OverrideUtil
...
Cohesion: 0.07
Nodes (4): ReplaceMeSubsystem, SubsystemBase, SubsystemBase(), HatchSubsystem
...
Cohesion: 0.07
Nodes (29): 0.10.2, 0.18.9, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+21 more)
...
Cohesion: 0.08
Nodes (22): consumeLines(), defaultRunCommandFactory(), dockerRunScript(), lineLooksReady(), randomRunId(), RunCommand, RunCommandContext, RunCommandFactory (+14 more)
...
Cohesion: 0.09
Nodes (5): WheelRadiusCharacterizationState, DoubleSupplier, RollerIOSpark, SpindexerIOSpark, TurretIOSpark
...
Cohesion: 0.19
Nodes (21): acceptWebSocket(), ActiveRun, activeRuns, collectProcess(), delay(), docker(), dockerExec(), killChild() (+13 more)

### Community 73 - "Community 73"
Cohesion: 0.1
Nodes (18): CodeContainerStatus, ContainerOrchestratorOptions, defaultDockerRunner(), dockerError(), DockerInspectContainer, labelsMatch(), lspRoleConfig, LspStatus (+10 more)
...
Cohesion: 0.12
Nodes (14): aliceRun, assert(), assertEditorProxy(), assertNt4AliveProbe(), assertSimProcessAlive(), bobRun, brokenAlice, Login (+6 more)
...
Cohesion: 0.11
Nodes (3): DefaultDrive, SysIdRoutineBot, TunableDouble

### Community 86 - "Community 86"
Cohesion: 0.16
Nodes (20): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (bun run measure -- --json), code:bash (# All managed containers), code:bash (# Container is auto-recreated on next run. If persistent:), code:bash (# Restart the code container) (+12 more)
...
Cohesion: 0.24
Nodes (13): addAllowlistEntry(), AllowlistData, isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist(), removeAllowlistEntry() (+5 more)

### Community 106 - "Community 106"
Cohesion: 0.16
Nodes (16): After, Before, code:java (public class Foo {), code:java (public class Bar {), Examples, Rename, dirExists(), fileExists() (+8 more)

### Community 107 - "Community 107"
Cohesion: 0.12
Nodes (5): GyroIONavX, GyroIOSim, GyroIO, VisionIOPhotonVision, VisionIO
...
Cohesion: 0.12
Nodes (4): ExtensionIOSpark, ExtensionIO, RollerIOSim, RollerIO
...
Cohesion: 0.15
Nodes (3): TurretIOSim, TurretIOTalonFX, TurretIO

### Community 152 - "Community 152"
Cohesion: 0.14
Nodes (3): ModuleIOSim, ModuleIO, SparkUtil
...
Cohesion: 0.27
Nodes (10): 1. Prerequisites, 3. Starting the App, 4. Stopping the App, Between class sessions, FRC Web Simulator V1 — Operator Runbook, FRC Web Simulator V2 — Operator Runbook, Graceful stop, Quick Reference Card (+2 more)
...
Cohesion: 0.36
Nodes (8): 8. Monitoring, Admin status API, code:bash (docker system prune -f          # Remove unused containers, ), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run measure), Docker container status, Resource measurement, Watch for issues

### Community 276 - "Community 276"
Cohesion: 0.32
Nodes (8): 6. Backup and Restore, code:bash (bun run backup), code:bash (bun run backup -- --output /path/to/backup), code:bash (bun run restore -- <backup-dir>), Create a backup, Recommended backup schedule, Restore from backup, What to back up
...
Cohesion: 0.33
Nodes (4): code:java (String message = getMessage();), code:java (String message = getMessage();), `invertEquals`, Java Clean Ups
...
## Knowledge Gaps
- **3807 isolated node(s):** `workspaceSlugSchema`, `userIdSchema`, `workspaceIdSchema`, `displayNameSchema`, `workspaceRouteSchema` (+3802 more)
...
- **Why does `Robot` connect `Community 41` to `Community 17`, `Community 3`, `Community 165`, `Community 111`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 68` to `Community 57`, `Community 5`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `isWorkspaceSlug()` connect `Community 37` to `Community 148`, `Community 6`?**

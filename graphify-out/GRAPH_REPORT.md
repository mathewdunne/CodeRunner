# Graph Report - FRC-Programming-Training-Sim  (2026-05-15)

## Corpus Check
- 5216 files · ~3,650,238 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15133 nodes · 26607 edges · 1554 communities (1008 shown, 546 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 391 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b8914bd2`
...
## Communities (1554 total, 546 thin omitted)
...
Cohesion: 0.01
Nodes (9): Command, ArcadeDrive, DriveDistance, DriveTime, TurnDegrees, TurnTime, m_autoTime(), SlowDriveSpeedCommand (+1 more)
...
Cohesion: 0.03
Nodes (229): AccessibilityInformation, AuthenticationForceNewSessionOptions, AuthenticationGetSessionOptions, AuthenticationProviderAuthenticationSessionsChangeEvent, AuthenticationProviderOptions, AuthenticationSessionsChangeEvent, BranchCoverage, BreakpointsChangeEvent (+221 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (229): AuthenticationProvider, AuthenticationProviderInformation, AuthenticationSession, AuthenticationSessionAccountInformation, AutoClosingPair, Breakpoint, CallHierarchyIncomingCall, CallHierarchyItem (+221 more)
...
Cohesion: 0.02
Nodes (21): RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer (+13 more)
...
Cohesion: 0.03
Nodes (93): handleUploadAsset(), userAssetsPath(), requireAdmin(), requireSession(), Rename, input, stripped, apiError() (+85 more)
...
Cohesion: 0.04
Nodes (86): handleAdminRoute(), addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry() (+78 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (12): DriveCommands, WheelRadiusCharacterizationState, Initialize(), IsFinished(), ReleaseHatch, SetBrakeModeCommand, InstantCommand, ReplaceMeInstantCommand (+4 more)
...
Cohesion: 0.04
Nodes (48): ControlApp, ControlAppOptions, GamepadSocketData, HalSimSocketData, ImportSocketData, Nt4SocketData, RunSocketData, VscodeSocketData (+40 more)
...
Cohesion: 0.07
Nodes (64): AdminRouteContext, log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest, contentTypeFor() (+56 more)
...
Cohesion: 0.05
Nodes (7): DoubleSupplier, KickerIOSpark, RollerIOSpark, SpindexerIOSpark, Drive, TurretIOSpark, SparkUtil
...
Cohesion: 0.04
Nodes (45): 0.15.1 - 2019-03-19, 0.1.0 - 2017-12-01, 0.22.4, 0.24.1, 0.27.0, 0.30.1, 0.31.1, 0.31.3 (+37 more)

### Community 35 - "Community 35"
Cohesion: 0.04
Nodes (45): 0.12.1 - 2018-8-31, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+37 more)
...
Cohesion: 0.05
Nodes (3): StopDrivingCommand, AssistedDriveCommand, DriveToPoseCommand
...
Cohesion: 0.06
Nodes (31): BigButton(), BigButtonProps, EnableDisableRow(), EnableDisableRowProps, onSetEnabled, TONE_ACTIVE, MODE_CLASSES, MODE_LABELS (+23 more)
...
Cohesion: 0.06
Nodes (3): OuttakeCommand, IntakeCommand, ShootIfReadyCommand
...
Cohesion: 0.08
Nodes (23): EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip() (+15 more)
...
Cohesion: 0.09
Nodes (20): consoleErrors, echoPromise, helloPromise, ws, ws1, ws2, seedRuntimeMissing(), seedRuntimeRunning() (+12 more)
...
Cohesion: 0.32
Nodes (11): ArcadeDrive(), DynamicProfiledDriveDistance(), GetAverageEncoderDistance(), GetLeftEncoderDistance(), GetRightEncoderDistance(), InitSendable(), Periodic(), ProfiledDriveDistance() (+3 more)
...
Cohesion: 0.07
Nodes (23): 0.18.5, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+15 more)
...
Cohesion: 0.07
Nodes (28): 0.18.5, 0.1.0 - 2018-10-19, 0.23.4, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2 (+20 more)
...
Cohesion: 0.07
Nodes (5): GyroIONavX, GyroIOPigeon2, GyroIOSim, PhoenixOdometryThread, GyroIO
...
Cohesion: 0.12
Nodes (3): round, AllianceFlipUtil, GeometryUtil
...
Cohesion: 0.42
Nodes (10): Drive(), getCurrentWheelDistances(), getCurrentWheelSpeeds(), GetHeading(), GetPose(), GetTurnRate(), ResetOdometry(), SetModuleStates() (+2 more)
...
Cohesion: 0.18
Nodes (20): 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 5. Configuration, 6. Backup and Restore, 7. Cache Cleanup, 8. Monitoring, Between class sessions (+12 more)
...
Cohesion: 0.14
Nodes (20): 2.1 Clone and initialize, 2.2 Build container images, 2.2 Build the code container image, 2.3 Build web assets, 2.4 Configure environment, 2.5 Run migrations, 2.6 Verify the setup, 2.7 Measure host resources (+12 more)
...
Cohesion: 0.1
Nodes (20): Alternative Thread Dump Methods, code:bash (# Step 1: Find the Java process ID), code:block27 (Found one Java-level deadlock:), code:block28 (// Inspect variables in thread #15 (worker-2)), code:block29 (vscjava.vscode-java-debug/getDebugThreads()), code:markdown (## Hypothesis), code:block31 (// Check main thread's view), code:block32 (vscjava.vscode-java-debug/debugStepOperation(operation="step) (+12 more)
...
Cohesion: 0.13
Nodes (19): 11. Project Import, 12. Container Concurrency Cap, 13. Audit Log, code:bash (CODE_MEMORY_LIMIT=3072m), code:block47 (data/users/<workspaceId>/backups/import-<timestamp>.tar.gz  ), code:bash (# Find the backup path), code:bash (MAX_ACTIVE_CONTAINERS=10   # default), code:bash (# Read current cap) (+11 more)

### Community 172 - "Community 172"
Cohesion: 0.14
Nodes (19): code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), code:bash (bun run backup) (+11 more)
...
Cohesion: 0.17
Nodes (16): Admin status API, code:bash (bun run docker:cleanup), code:bash (bun run docker:cleanup -- --dry-run), code:bash (rm -rf data/users/<workspaceId>/home/), code:bash (rm -rf data/users/<workspaceId>/logs/runs/*), code:bash (for dir in data/users/*/; do), code:bash (docker system prune -f          # Remove unused containers, ), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos) (+8 more)
...
Cohesion: 0.26
Nodes (13): 10. Host Sizing, code:bash (bun run dev:control), code:bash (bun run migrate:status  # verify DB is accessible), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" \), code:bash (bun run measure), code:block44 (═══ CodeRunner — Resource Report ═══), code:bash (CODE_MEMORY_LIMIT=2048m), Measuring actual usage (+5 more)
...
Cohesion: 0.67
Nodes (3): code:block24 (vscjava.vscode-java-debug/getDebugThreads()), code:block25 (═══════════════════════════════════════════), Understanding Thread States
...
## Knowledge Gaps
- **3728 isolated node(s):** `nosniff`, `cookie`, `console`, `consoleErrors`, `leaseErrors` (+3723 more)
...
- **Why does `Robot` connect `Community 0` to `Community 96`, `Community 124`, `Community 182`, `Community 54`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 54` to `Community 24`, `Community 19`, `Community 12`, `Community 21`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `isWorkspaceSlug()` connect `Community 56` to `Community 234`, `Community 20`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **What connects `nosniff`, `cookie`, `console` to the rest of the system?**
  _3728 weakly-connected nodes found - possible documentation gaps or missing edges._

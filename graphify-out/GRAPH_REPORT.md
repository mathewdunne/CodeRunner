...
## Corpus Check
- 1075 files · ~743,089 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9273 nodes · 11816 edges · 1143 communities (720 shown, 423 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 283 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ecf3b0fc`
...
## Communities (1143 total, 423 thin omitted)
...
Cohesion: 0.02
Nodes (13): Command, ReplaceMeCommand, ArcadeDrive, Autos, DriveDistance, DriveTime, ExampleCommand, HalveDriveSpeed (+5 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (19): Robot, Robot, main(), Robot(), Robot, Robot, Robot, Robot (+11 more)
...
Cohesion: 0.06
Nodes (62): ControlAppOptions, createApp(), DockerRunner, RunCommandFactory, aliceCookie, cookie, ids, insertUser (+54 more)
...
Cohesion: 0.08
Nodes (15): codeContainerName(), containerName(), ContainerOrchestrator, containerRuntimeState(), dockerPortBindError(), leaseContainerNameFor(), leasePortFor(), leaseStateFor() (+7 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (54): apiErrorResponse(), AppSocket, AssetManifest, authFromRequest(), autoChoosersSnapshot(), BunUpgradeServer, capacityErrorResponse(), containersStatusResponse() (+46 more)
...
Cohesion: 0.04
Nodes (49): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.20.0 - 2019-07-01, 0.22.0 - 2019-09-24, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21 (+41 more)
...
Cohesion: 0.07
Nodes (35): RunControls(), RunControlsProps, pillVariant(), StatusStrip(), StatusStripProps, TopbarProps, BigButton(), BigButtonProps (+27 more)
...
Cohesion: 0.07
Nodes (34): Auth, AuthCallbacks, createAuth(), buildSocialProviders(), getEnabledAuthProviders(), OAuthProvider, SocialProviders, AuditActor (+26 more)
...
Cohesion: 0.09
Nodes (23): InitialsAvatar(), UserMenuProps, MatchTimer(), MatchTimerProps, STATION_LABELS, STATIONS, authClient, cn() (+15 more)
...
Cohesion: 0.09
Nodes (22): EditorPane(), EditorPaneProps, ScopePane, ScopePaneProps, Topbar(), useAutoChoosers(), UseAutoChoosersReturn, useContainerStatus() (+14 more)
...
Cohesion: 0.07
Nodes (29): 0.18.7, 0.23.1, 0.23.6, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2 (+21 more)
...
Cohesion: 0.09
Nodes (13): PathUnderTrenchCommand, AllianceFlipUtil, Depot, FieldConstants, Hub, LeftBump, LeftTrench, LinesHorizontal (+5 more)
...
Cohesion: 0.1
Nodes (4): StopDrivingCommand, DriveCommands, WheelRadiusCharacterizationState, DriveToPoseCommand
...
Cohesion: 0.12
Nodes (25): 12. Container Concurrency Cap, 13. Audit Log, 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 8. Monitoring, Between class sessions, code:bash (MAX_ACTIVE_CONTAINERS=10   # default) (+17 more)
...
Cohesion: 0.09
Nodes (21): CodeContainerStatus, ContainerOrchestratorOptions, defaultDockerRunner(), DockerCommandResult, dockerError(), DockerInspectContainer, isLoopbackHost(), labelsMatch() (+13 more)
...
Cohesion: 0.17
Nodes (19): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (bun run measure), code:bash (bun run measure -- --json), code:bash (# All managed containers), code:bash (# Container is auto-recreated on next run. If persistent:) (+11 more)
...
Cohesion: 0.22
Nodes (14): getSessionFromRequest(), isAllowedWebSocketOrigin(), isLoopbackHost(), normalizeHost(), requireAdmin(), requireSession(), requireWebSocketOrigin(), requireWorkspaceOwnership() (+6 more)
...
Cohesion: 0.25
Nodes (7): adminCookie, body, fakeDocker, rows, student, studentCookie, workspace
...
Cohesion: 0.33
Nodes (4): code:java (if (0 < i) {), code:java (if (0 < i) {), Java Clean Ups, `redundantFallingThroughBlockEnd`
...
- **423 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 43` to `Community 171`, `Community 4`, `Community 20`, `Community 23`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 74` to `Community 9`, `Community 38`?**

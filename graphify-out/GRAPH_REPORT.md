# Graph Report - CodeRunner  (2026-05-18)

## Corpus Check
- 1016 files · ~899,954 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17038 nodes · 31413 edges · 1728 communities (1174 shown, 554 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 392 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e20b30c5`
...
1. `main()` - 528 edges
2. `Robot()` - 474 edges
3. `TeleopPeriodic()` - 184 edges
4. `RobotPeriodic()` - 176 edges
5. `Change Log` - 173 edges
6. `DisabledInit()` - 152 edges
7. `TeleopInit()` - 152 edges
8. `Change Log` - 150 edges
9. `DriveSubsystem` - 139 edges
10. `AutonomousInit()` - 136 edges

## Surprising Connections (you probably didn't know these)
- `restoreArchive()` --calls--> `Rename`  [INFERRED]
  scripts/restore.ts → data/users/ws_e5346a69de1c0891e95048a64a71d9e4/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `saveAllowlist()` --calls--> `Rename`  [INFERRED]
  apps/control/src/auth/allowlist.ts → data/users/ws_e5346a69de1c0891e95048a64a71d9e4/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `restoreProjectArchive()` --calls--> `Rename`  [INFERRED]
  apps/control/src/app/archive-utils.ts → data/users/ws_e5346a69de1c0891e95048a64a71d9e4/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
- `restoreProjectArchive()` --calls--> `Rename`  [INFERRED]
  apps/control/src/app.ts → data/users/ws_e5346a69de1c0891e95048a64a71d9e4/home/extensions/redhat.java-1.54.0-linux-x64/document/_java.learnMoreAboutRefactorings.md
...
## Communities (1728 total, 554 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.0
Nodes (49): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+41 more)
...
Cohesion: 0.01
Nodes (9): Command, DriveDistance, DriveTime, TurnTime, m_autoTime(), LoggedRobot, RapidReactCommandBot, AimHoodAndSpinFlywheelCommand (+1 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (229): AuthenticationProviderInformation, AuthenticationSession, AutoClosingPair, Breakpoint, BreakpointsChangeEvent, CallHierarchyItem, CancellationError, CancellationTokenSource (+221 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (229): AccessibilityInformation, AuthenticationForceNewSessionOptions, AuthenticationGetSessionOptions, AuthenticationProvider, AuthenticationProviderAuthenticationSessionsChangeEvent, AuthenticationProviderOptions, AuthenticationSessionAccountInformation, AuthenticationSessionsChangeEvent (+221 more)
...
Cohesion: 0.02
Nodes (16): DefaultDrive, Execute(), DoubleSupplier, ModuleIOSpark, SparkOdometryThread, ExtensionIOSpark, FlywheelIOSpark, HoodIOSpark (+8 more)
...
Cohesion: 0.03
Nodes (15): RobotContainer, RobotContainer, ShootUntilHopperEmptyCommand, Initialize(), IsFinished(), ReleaseHatch, SetBrakeModeCommand, ShiftChangeRumbleLEDCommand (+7 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (89): ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, AuditLogEntry, DockerCommandResult (+81 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (88): input, stripped, apiError(), apiErrorResponse(), AppSocket, assertRealPathInside(), AssetManifest, authFromRequest() (+80 more)
...
Cohesion: 0.03
Nodes (10): Main, Main, Main, Main, Main, RobotBase, Main, Main (+2 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (60): body, body, body, body, absolute, refs, headers, received (+52 more)
...
Cohesion: 0.05
Nodes (44): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), defaultDockerRunner(), dockerError(), dockerPortBindError(), inspectContainer() (+36 more)
...
Cohesion: 0.03
Nodes (3): AutonomousDistance, AutonomousTime, SequentialCommandGroup
...
Cohesion: 0.04
Nodes (67): setAllowlistPath(), Auth, AuthCallbacks, createAuth(), log, buildSocialProviders(), getEnabledAuthProviders(), OAuthProvider (+59 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (67): AdminRouteContext, log, AssetManifest, contentTypeFor(), handleUploadAsset(), isInsideDirectory(), readScopeAssetManifest(), safeRelativeAssetPath() (+59 more)
...
Cohesion: 0.03
Nodes (73): AdminActionResponse, adminActionResponseSchema, AdminStatusResponse, adminStatusResponseSchema, AdminWorkspaceStatus, adminWorkspaceStatusSchema, AllianceStation, AuthProvider (+65 more)
...
Cohesion: 0.04
Nodes (38): sendUpstreamWebSocketMessage(), AppSocket, ControlApp, ControlAppOptions, GamepadSocketData, HalSimSocketData, ImportSocketData, Nt4SocketData (+30 more)
...
Cohesion: 0.06
Nodes (35): ScopePane, ScopePaneProps, Topbar(), patchCall, { result }, updatedResponse, VALID_RESPONSE, useAutoChoosers() (+27 more)
...
Cohesion: 0.04
Nodes (43): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.4, 0.30.0, 0.30.1, 0.31.3, 0.33.1, 0.35.2 (+35 more)

### Community 38 - "Community 38"
Cohesion: 0.04
Nodes (43): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+35 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (35): IDELayout(), IDELayoutProps, Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimer(), MatchTimerProps (+27 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (49): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.30.0, 0.30.1, 0.31.0 (+41 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (42): 0.12.2 - 2018-9-6, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.31.0 - 2021-02-02, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.40.0 - 2022-03-28 (+34 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (32): first, NUM_RUNS, second, projectDir, samples, workspace, cases, expectRejected() (+24 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (5): ExtensionIO, IntakeSubsystem, RollerIOSim, RollerIO, SimShotVisualizer
...
Cohesion: 0.05
Nodes (5): StopDrivingCommand, DriveCommands, WheelRadiusCharacterizationState, DriveToPoseCommand, SysIDCommands

### Community 46 - "Community 46"
Cohesion: 0.1
Nodes (6): ContainerOrchestrator, dockerError(), dockerPortBindError(), simContainerName(), workspaceHomePath(), workspaceJdtLsDataPath()
...
Cohesion: 0.06
Nodes (35): BigButton(), BigButtonProps, EnableDisableRow(), EnableDisableRowProps, onSetEnabled, TONE_ACTIVE, MODE_CLASSES, MODE_LABELS (+27 more)
...
Cohesion: 0.07
Nodes (3): TrenchDuckCommand, LaunchCalculator, AllianceFlipUtil
...
Cohesion: 0.06
Nodes (28): assert(), assertEditorProxy(), assertNt4AliveProbe(), assertSimProcessAlive(), buildingTimes, Login, logins, originals (+20 more)
...
Cohesion: 0.07
Nodes (25): AutoPanel(), AutoPanelProps, ControlsPanel(), ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES (+17 more)

### Community 61 - "Community 61"
Cohesion: 0.12
Nodes (4): codeContainerName(), containerRuntimeState(), LocalDockerRuntimeProvider, runtimeFromLease()

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (24): BridgeEntry, DEFAULT_DRIVER_STATION, defaultSnapshot(), DriverStationState, HalSimBridge, HalSimBridgeOptions, HalSimBridgeSnapshot, HalSimMessage (+16 more)
...
Cohesion: 0.06
Nodes (17): AdminApp(), ResolvedTheme, Theme, THEME_VALUES, ThemeProvider(), ThemeProviderContext, ThemeProviderProps, ThemeProviderState (+9 more)

### Community 69 - "Community 69"
Cohesion: 0.11
Nodes (14): consumeLines(), defaultRunCommandFactory(), dockerRunScript(), lineLooksReady(), log, randomRunId(), RunCommand, RunCommandContext (+6 more)
...
Cohesion: 0.1
Nodes (22): EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, pillVariant(), StatusStrip(), StatusStripProps, TopbarProps (+14 more)

### Community 82 - "Community 82"
Cohesion: 0.08
Nodes (20): BINDING_GROUPS, Bumper(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer(), SmallButton(), StatusTone (+12 more)

### Community 83 - "Community 83"
Cohesion: 0.06
Nodes (34): 1. GCP project, 2. Terraform state bucket, 3. Configure Terraform vars, 4. Apply, 5. Populate Secret Manager, 6. DNS, 7. Re-render config on the VM, 8. Configure GitHub repo for the deploy workflow (+26 more)

### Community 84 - "Community 84"
Cohesion: 0.09
Nodes (24): ConsolePane(), ConsolePaneProps, CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun(), ConsoleLine(), ConsolePanel() (+16 more)
...
Cohesion: 0.11
Nodes (24): containerName(), ContainerOrchestratorOptions, defaultDockerRunner(), DockerInspectContainer, isLoopbackHost(), labelsMatch(), leaseContainerNameFor(), leasePortFor() (+16 more)
...
Cohesion: 0.08
Nodes (24): activeWorkspaces, DockerStatsPoller, DockerStatsPollerOptions, log, containerCpuPercent, containerMemoryPercent, containerStartBuckets, containerStartDuration (+16 more)

### Community 98 - "Community 98"
Cohesion: 0.07
Nodes (4): ModuleIO, RobotContainer, TurretIO, VisionIO
...
Cohesion: 0.09
Nodes (16): Listener, FakeWebSocket, announceChooser(), body, controlled, cookie, encodeMsgPack(), fakeDocker (+8 more)
...
Cohesion: 0.16
Nodes (27): applyAdvantageScopePatches(), ascopeRoot, CommandResult, patchDir, patchFiles(), repoRoot, run(), ascopeLiteStatic (+19 more)

### Community 105 - "Community 105"
Cohesion: 0.13
Nodes (25): handleAdminRoute(), createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), addAllowlistEntry(), AllowlistData, getAllowlist() (+17 more)
...
Cohesion: 0.07
Nodes (26): 0.10.2, 0.23.6, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+18 more)
...
Cohesion: 0.15
Nodes (29): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token), code:alloy (prometheus.scrape "control_plane" {) (+21 more)
...
Cohesion: 0.11
Nodes (3): Indexer, LoggedTunableNumber, VirtualPD

### Community 137 - "Community 137"
Cohesion: 0.11
Nodes (24): code:powershell (git submodule update --init --recursive), code:text (apps/control/                  Bun control plane with login,), code:text (apps/control/src/__tests__/        Bun tests: auth, runs, pr), CodeRunner, Commands, Layout, Observability, Operator Runbook (+16 more)

### Community 138 - "Community 138"
Cohesion: 0.1
Nodes (9): bashCalls, cloneCall, ctx, importer, mock, row, workspace, ImportContext (+1 more)
...
Cohesion: 0.15
Nodes (22): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 8. Monitoring, Between class sessions (+14 more)
...
Cohesion: 0.09
Nodes (20): aliceConnection, aliceMessages, aliceRun, aliceRunId, aliceWorkspace, baseOptions, bobConnection, bobMessages (+12 more)

### Community 166 - "Community 166"
Cohesion: 0.13
Nodes (18): asWebSocket(), handleUpgrade(), httpServer, LanguageServerRunConfig, launchLanguageServer(), nt4HttpUrl(), nt4WsUrl(), parseSessions() (+10 more)
...
Cohesion: 0.2
Nodes (17): 11. Project Import, code:bash (CODE_MEMORY_LIMIT=3072m), code:block46 (data/users/<workspaceId>/backups/import-<timestamp>.tar.gz  ), code:bash (# Find the backup path), code:bash (MAX_ACTIVE_CONTAINERS=10   # default), code:bash (# Read current cap), code:bash (# Latest entries), code:bash (# Remove entries older than 90 days (default)) (+9 more)
...
Cohesion: 0.12
Nodes (15): authProvidersResponseSchema, autoChooserPatchSchema, autoChoosersResponseSchema, createFileRequestSchema, gamepadClientMessageSchema, gamepadServerMessageSchema, getProjectPathAccess(), isProjectPath() (+7 more)
...
Cohesion: 0.13
Nodes (14): first, NUM_RUNS, parsed, slugArb, allianceStationSchema, bridgeConnectionSchema, containerStateSchema, driverStationPatchSchema (+6 more)
...
Cohesion: 0.25
Nodes (7): slugFromEmail(), emailArb, now, NUM_RUNS, slug, slugs, ControlApp
...
## Knowledge Gaps
- **4021 isolated node(s):** `nosniff`, `cookie`, `console`, `consoleErrors`, `leaseErrors` (+4016 more)
...
- **Why does `Robot` connect `Community 0` to `Community 2`, `Community 36`, `Community 136`, `Community 43`, `Community 109`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 69` to `Community 28`, `Community 13`, `Community 23`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `Vision` connect `Community 205` to `Community 192`, `Community 5`?**

...
## Corpus Check
- 5046 files · ~3,580,951 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14097 nodes · 24569 edges · 1464 communities (955 shown, 509 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 374 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1a4f5e6b`
...
## Communities (1464 total, 509 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (48): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+40 more)
...
Cohesion: 0.01
Nodes (8): Command, DriveDistance, DriveToPoseCommand, TurnTime, m_autoTime(), LoggedRobot, RapidReactCommandBot, SlowDriveSpeedCommand

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (229): AuthenticationForceNewSessionOptions, AuthenticationGetSessionOptions, AuthenticationProvider, AuthenticationProviderAuthenticationSessionsChangeEvent, AutoClosingPair, Breakpoint, BreakpointsChangeEvent, CallHierarchyItem (+221 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (229): AccessibilityInformation, AuthenticationProviderInformation, AuthenticationProviderOptions, AuthenticationSession, AuthenticationSessionAccountInformation, AuthenticationSessionsChangeEvent, BranchCoverage, CallHierarchyIncomingCall (+221 more)
...
Cohesion: 0.02
Nodes (15): DefaultDrive, Execute(), DoubleSupplier, ModuleIOSpark, SparkOdometryThread, ExtensionIOSpark, FlywheelIOSpark, HoodIOSpark (+7 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (97): getSessionFromRequest(), isAllowedWebSocketOrigin(), isLoopbackHost(), normalizeHost(), requireAdmin(), requireSession(), requireWebSocketOrigin(), requireWorkspaceOwnership() (+89 more)
...
Cohesion: 0.04
Nodes (11): Main, Main, Main, Main, Main, Main, Main, Main (+3 more)
...
Cohesion: 0.05
Nodes (5): AssistedDriveCommand, TrenchDuckCommand, LaunchCalculator, AllianceFlipUtil, GeometryUtil
...
Cohesion: 0.06
Nodes (36): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimer(), MatchTimerProps, STATION_LABELS, STATIONS (+28 more)
...
Cohesion: 0.05
Nodes (41): assert(), assertEditorProxy(), assertNt4AliveProbe(), assertSimProcessAlive(), buildingTimes, Login, logins, originals (+33 more)
...
Cohesion: 0.06
Nodes (34): AutoPanel(), AutoPanelProps, ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES, IconRail() (+26 more)
...
Cohesion: 0.04
Nodes (45): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.22.2, 0.27.0, 0.30.0, 0.31.0, 0.31.1, 0.31.3 (+37 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (45): 0.12.1 - 2018-8-31, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+37 more)
...
Cohesion: 0.04
Nodes (44): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.1.0 - 2017-09-27, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.0 - 2021-03-12, 0.32.1 - 2021-03-23 (+36 more)

### Community 40 - "Community 40"
Cohesion: 0.07
Nodes (36): RunControls(), RunControlsProps, pillVariant(), StatusStrip(), StatusStripProps, TopbarProps, BigButton(), BigButtonProps (+28 more)
...
Cohesion: 0.08
Nodes (3): DefaultCommands, OperatorPanel, SubsystemFactory
...
Cohesion: 0.09
Nodes (21): EditorPane(), EditorPaneProps, ScopePane, ScopePaneProps, Topbar(), useAutoChoosers(), UseAutoChoosersReturn, useContainerStatus() (+13 more)
...
Cohesion: 0.08
Nodes (19): Bumper(), ControlsPanel(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer(), SmallButton(), StatusTone (+11 more)
...
Cohesion: 0.08
Nodes (6): GyroIONavX, ModuleIO, TurretIO, VisionIOPhotonVision, VisionIO, VisionIOPhotonVision
...
Cohesion: 0.11
Nodes (3): VisionIOPhotonVisionSim, VisionConsumer, VisionSubsystem
...
Cohesion: 0.17
Nodes (20): 12. Container Concurrency Cap, 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 7. Cache Cleanup, 8. Monitoring, Between class sessions, code:bash (MAX_ACTIVE_CONTAINERS=10   # default) (+12 more)
...
Cohesion: 0.4
Nodes (5): ReachGoal(), Reset(), SimulationPeriodic(), Stop(), UpdateTelemetry()
...
Cohesion: 0.12
Nodes (16): authProvidersResponseSchema, autoChooserPatchSchema, autoChoosersResponseSchema, createFileRequestSchema, driverStationPatchSchema, gamepadClientMessageSchema, gamepadServerMessageSchema, gamepadStateSchema (+8 more)
...
Cohesion: 0.17
Nodes (16): 5. Configuration, code:bash (bun run measure), code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m) (+8 more)
...
Cohesion: 0.19
Nodes (14): 10. Host Sizing, code:bash (bun run migrate:status  # verify DB is accessible), code:bash (# Check Docker is running), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" \), code:bash (bun run measure), code:block41 (═══ CodeRunner — Resource Report ═══), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=3072m) (+6 more)
...
Cohesion: 0.53
Nodes (4): LoadPreferences(), ReachSetpoint(), SimulationPeriodic(), Stop()
...
## Knowledge Gaps
- **3358 isolated node(s):** `workspaceSlugSchema`, `userIdSchema`, `workspaceIdSchema`, `displayNameSchema`, `workspaceRouteSchema` (+3353 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **509 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 75` to `Community 0`, `Community 2`, `Community 79`, `Community 49`, `Community 214`, `Community 22`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 100` to `Community 11`, `Community 30`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `isWorkspaceSlug()` connect `Community 55` to `Community 192`, `Community 17`?**

# Graph Report - CodeRunner  (2026-05-17)

## Corpus Check
- 5213 files · ~3,640,346 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15321 nodes · 26827 edges · 1570 communities (1022 shown, 548 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 391 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ac25805d`
...
## Communities (1570 total, 548 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (45): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+37 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (12): WaitUntilHopperIsEmptyCommand, Command, DriveDistance, DriveToPoseCommand, ExampleCommand, OuttakeCommand, SysIDCommands, m_autoTime() (+4 more)
...
Cohesion: 0.03
Nodes (229): AccessibilityInformation, AuthenticationForceNewSessionOptions, AuthenticationGetSessionOptions, AuthenticationProvider, AuthenticationProviderAuthenticationSessionsChangeEvent, AuthenticationProviderInformation, AuthenticationProviderOptions, AuthenticationSession (+221 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (229): AuthenticationSessionAccountInformation, CallHierarchyOutgoingCall, CallHierarchyProvider, CancellationError, CancellationToken, CancellationTokenSource, CharacterPair, ChatFollowup (+221 more)
...
Cohesion: 0.02
Nodes (140): bashCalls, cloneCall, ctx, importer, mock, row, workspace, ADMIN_GET_ROUTES (+132 more)
...
Cohesion: 0.03
Nodes (16): RobotContainer, RobotContainer, RobotContainer, ShootUntilHopperEmptyCommand, Initialize(), IsFinished(), ReleaseHatch, SetBrakeModeCommand (+8 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (99): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+91 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (94): handleUploadAsset(), userAssetsPath(), getSessionFromRequest(), requireSession(), Rename, input, stripped, apiError() (+86 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (10): DoubleSupplier, ExtensionIOSpark, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, SpindexerIOSpark, Drive, TurretIOSpark (+2 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (48): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), defaultDockerRunner(), dockerError(), dockerPortBindError(), inspectContainer() (+40 more)
...
Cohesion: 0.04
Nodes (11): Main, Main, Main, Main, Main, Main, Main, RobotBase (+3 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (71): setAllowlistPath(), Auth, AuthCallbacks, createAuth(), log, slugFromEmail(), buildSocialProviders(), getEnabledAuthProviders() (+63 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (49): sendUpstreamWebSocketMessage(), AppSocket, ControlApp, ControlAppOptions, GamepadSocketData, HalSimSocketData, ImportSocketData, Nt4SocketData (+41 more)
...
Cohesion: 0.07
Nodes (9): AutoCloseable, ExtensionIOSim, PotentiometerPIDTest, Elevator, ReachGoal(), Reset(), SimulationPeriodic(), Stop() (+1 more)
...
Cohesion: 0.06
Nodes (35): RunControls(), RunControlsProps, ScopePaneProps, pillVariant(), StatusStrip(), StatusStripProps, TopbarProps, MODE_CLASSES (+27 more)
...
Cohesion: 0.05
Nodes (37): EditorPane(), EditorPaneProps, ScopePane, Topbar(), patchCall, { result }, updatedResponse, VALID_RESPONSE (+29 more)
...
Cohesion: 0.04
Nodes (45): 0.15.1 - 2019-03-19, 0.22.2, 0.22.4, 0.24.1, 0.30.0, 0.31.0, 0.31.1, 0.31.3 (+37 more)

### Community 36 - "Community 36"
Cohesion: 0.04
Nodes (44): 0.12.2 - 2018-9-6, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+36 more)

### Community 37 - "Community 37"
Cohesion: 0.04
Nodes (44): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.32.1 - 2021-03-23 (+36 more)
...
Cohesion: 0.07
Nodes (30): Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimer(), MatchTimerProps, STATION_LABELS, STATIONS (+22 more)
...
Cohesion: 0.07
Nodes (26): AutoPanel(), AutoPanelProps, ControlsPanel(), ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES (+18 more)
...
Cohesion: 0.11
Nodes (4): ContainerOrchestrator, dockerPortBindError(), portIsFree(), workspaceJdtLsDataPath()
...
Cohesion: 0.06
Nodes (5): RobotContainer, TurretIO, VisionIOPhotonVisionSim, VisionIO, VisionIOPhotonVision
...
Cohesion: 0.13
Nodes (4): codeContainerName(), LocalDockerRuntimeProvider, publishedPortFor(), runtimeFromLease()

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (15): FakeSocket, Listener, { result }, { unmount }, FakeWebSocket, setupBridgeAndSocket(), bridge, enabledDisable (+7 more)
...
Cohesion: 0.06
Nodes (5): GyroIONavX, GyroIOPigeon2, GyroIOSim, GyroIO, VisionIOPhotonVision
...
Cohesion: 0.06
Nodes (30): 1. GCP project, 2. Terraform state bucket, 3. Configure Terraform vars, 4. Apply, 5. Populate Secret Manager, 6. DNS, 7. Re-render config on the VM, 8. Configure GitHub repo for the deploy workflow (+22 more)
...
Cohesion: 0.07
Nodes (23): 0.21.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+15 more)
...
Cohesion: 0.07
Nodes (28): 0.18.9, 0.19.1, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+20 more)
...
Cohesion: 0.11
Nodes (14): announceChooser(), body, controlled, cookie, encodeMsgPack(), fakeDocker, FakeWebSocket, messages (+6 more)
...
Cohesion: 0.16
Nodes (23): 7. Cache Cleanup, 8. Monitoring, Admin status API, code:bash (# on the laptop, after stopping local dev), code:bash (bun run docker:cleanup), code:bash (bun run docker:cleanup -- --dry-run), code:bash (rm -rf data/users/<workspaceId>/home/), code:bash (rm -rf data/users/<workspaceId>/logs/runs/*) (+15 more)
...
Cohesion: 0.16
Nodes (21): 10. Host Sizing, 12. Container Concurrency Cap, 13. Audit Log, 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 6. Backup and Restore, Between class sessions (+13 more)

### Community 136 - "Community 136"
Cohesion: 0.12
Nodes (22): 5. Configuration, code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m) (+14 more)
...
Cohesion: 0.1
Nodes (17): ContainerOrchestratorOptions, defaultDockerRunner(), DockerCommandResult, DockerInspectContainer, isLoopbackHost(), LocalDockerRuntimeProviderOptions, lspRoleConfig, LspStatus (+9 more)
...
Cohesion: 0.14
Nodes (12): seedRuntimeMissing(), seedRuntimeRunning(), snapshot, cookie, frames, snap, status, cookie (+4 more)
...
Cohesion: 0.28
Nodes (18): ascopeLiteStatic, ascopeRoot, compileLite(), compileWasm(), distDir, ensureEmscripten(), ensureSubmodule(), envWithEmsdk() (+10 more)
...
Cohesion: 0.16
Nodes (6): containerRuntimeState(), dockerError(), parseDockerStatsLine(), parsePercent(), v2LabelsMatch(), workspaceHomePath()
...
Cohesion: 0.24
Nodes (14): addAllowlistEntry(), AllowlistData, EMPTY, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry() (+6 more)
...
Cohesion: 0.24
Nodes (7): containerName(), labelsMatch(), leaseContainerNameFor(), leasePortFor(), leaseStateFor(), RoleConfig, statusFromLease()
...
## Knowledge Gaps
- **3844 isolated node(s):** `nosniff`, `cookie`, `console`, `consoleErrors`, `leaseErrors` (+3839 more)
...
- **Why does `Robot` connect `Community 103` to `Community 0`, `Community 256`, `Community 1`, `Community 38`, `Community 43`, `Community 95`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `isWorkspaceSlug()` connect `Community 55` to `Community 96`, `Community 20`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 56` to `Community 19`, `Community 11`, `Community 12`?**

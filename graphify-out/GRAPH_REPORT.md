# Graph Report - CodeRunner  (2026-05-20)

## Corpus Check
- 1015 files · ~899,468 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17069 nodes · 31447 edges · 1720 communities (1167 shown, 553 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 392 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c011fc93`
...
## Communities (1720 total, 553 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.0
Nodes (51): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+43 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (11): StopDrivingCommand, Command, ReplaceMeCommand, DriveDistance, DriveTime, DriveToPoseCommand, TurnDegrees, TurnTime (+3 more)
...
Cohesion: 0.03
Nodes (229): AccessibilityInformation, AuthenticationProvider, AuthenticationProviderAuthenticationSessionsChangeEvent, AuthenticationProviderInformation, BranchCoverage, Breakpoint, BreakpointsChangeEvent, CallHierarchyIncomingCall (+221 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (229): AuthenticationForceNewSessionOptions, AuthenticationGetSessionOptions, AuthenticationProviderOptions, AuthenticationSession, AuthenticationSessionAccountInformation, AuthenticationSessionsChangeEvent, AutoClosingPair, CallHierarchyOutgoingCall (+221 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (8): ReplaceMeSubsystem, SubsystemBase, output(), DriveSubsystem, SubsystemBase(), RomiDrivetrain, log(), SubsystemBase()
...
Cohesion: 0.02
Nodes (155): ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp(), DockerRunner (+147 more)
...
Cohesion: 0.02
Nodes (18): DoubleSupplier, ModuleIOSpark, SparkOdometryThread, ExtensionIOSpark, FlywheelIOSpark, HoodIOSpark, KickerIOSpark, RollerIOSpark (+10 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (19): RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, ShootUntilHopperEmptyCommand, Initialize() (+11 more)
...
Cohesion: 0.03
Nodes (95): handleAdminRoute(), addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry() (+87 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (94): handleUploadAsset(), userAssetsPath(), getSessionFromRequest(), requireAdmin(), requireSession(), requireWorkspaceOwnership(), input, stripped (+86 more)
...
Cohesion: 0.05
Nodes (22): ArmSimulationTest, TEST_P(), ElevatorSimulationTest, TEST_F(), AllianceTest, AutonomousTest, callback(), EnabledTest (+14 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (10): Main, Main, Main, Main, Main, Main, Main, Main (+2 more)
...
Cohesion: 0.03
Nodes (8): PreSpinFlywheelCommand, SysIDCommands, FlywheelIOSim, FlywheelIO, HoodIOSim, HoodIO, ShooterSubsystem, AimHoodAndSpinFlywheelCommand
...
Cohesion: 0.06
Nodes (71): AdminRouteContext, log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest, contentTypeFor() (+63 more)
...
Cohesion: 0.05
Nodes (49): sendUpstreamWebSocketMessage(), AppSocket, createWebSocketHandlers(), log, WebSocketHandlerContext, first, NUM_RUNS, second (+41 more)
...
Cohesion: 0.05
Nodes (37): DEFAULT_PORT, GamepadLease, GamepadLeaseResolver, GamepadMessageOutcome, GamepadSessions, GamepadStatus, halsimTarget(), log (+29 more)
...
Cohesion: 0.08
Nodes (31): AdminLayout(), Tab, tabs, RunControlsProps, useAdminPoll(), Allowlist(), AllowlistData, AuditEntry (+23 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (33): AutoPanel(), AutoPanelProps, ControlsPanel(), ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES (+25 more)
...
Cohesion: 0.04
Nodes (43): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.0, 0.30.1 (+35 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (33): patchCall, { result }, updatedResponse, VALID_RESPONSE, useAutoChoosers(), UseAutoChoosersReturn, { result }, { unmount } (+25 more)

### Community 45 - "Community 45"
Cohesion: 0.04
Nodes (49): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.27.0, 0.30.0, 0.30.1 (+41 more)

### Community 46 - "Community 46"
Cohesion: 0.04
Nodes (42): 0.12.1 - 2018-8-31, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.33.1 - 2021-04-30 (+34 more)

### Community 47 - "Community 47"
Cohesion: 0.04
Nodes (42): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+34 more)
...
Cohesion: 0.11
Nodes (3): ContainerOrchestrator, dockerPortBindError(), simContainerName()
...
Cohesion: 0.09
Nodes (29): containerName(), ContainerOrchestratorOptions, defaultDockerRunner(), DockerCommandResult, dockerError(), DockerInspectContainer, isLoopbackHost(), labelsMatch() (+21 more)

### Community 71 - "Community 71"
Cohesion: 0.06
Nodes (16): AdminApp(), ResolvedTheme, Theme, THEME_VALUES, ThemeProvider(), ThemeProviderContext, ThemeProviderProps, ThemeProviderState (+8 more)

### Community 72 - "Community 72"
Cohesion: 0.07
Nodes (27): BigButton(), BigButtonProps, EnableDisableRow(), EnableDisableRowProps, onSetEnabled, TONE_ACTIVE, MODE_CLASSES, MODE_LABELS (+19 more)
...
Cohesion: 0.09
Nodes (23): EditorPane(), EditorPaneProps, RunControls(), ScopePane, ScopePaneProps, pillVariant(), StatusStrip(), StatusStripProps (+15 more)
...
Cohesion: 0.08
Nodes (13): FakeSocket, Listener, { result }, { unmount }, bridge, enabledDisable, FakeWebSocket, flush (+5 more)
...
Cohesion: 0.07
Nodes (26): 0.10.1, 0.23.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+18 more)
...
Cohesion: 0.16
Nodes (28): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token), code:alloy (prometheus.scrape "control_plane" {) (+20 more)
...
Cohesion: 0.15
Nodes (22): 10. Host Sizing, 12. Container Concurrency Cap, 14. Cloudflare Pages (optional offline screen), 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 8. Monitoring, Between class sessions (+14 more)
...
Cohesion: 0.14
Nodes (12): aliceRun, assert(), assertEditorProxy(), assertNt4AliveProbe(), assertSimProcessAlive(), bobRun, brokenAlice, Login (+4 more)

### Community 197 - "Community 197"
Cohesion: 0.13
Nodes (19): 5. Configuration, code:bash (bun run start), code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m) (+11 more)

### Community 198 - "Community 198"
Cohesion: 0.18
Nodes (19): 11. Project Import, 13. Audit Log, code:bash (CODE_MEMORY_LIMIT=3072m), code:block46 (data/users/<workspaceId>/backups/import-<timestamp>.tar.gz  ), code:bash (# Find the backup path), code:bash (MAX_ACTIVE_CONTAINERS=10   # default), code:bash (# Read current cap), code:bash (# Latest entries) (+11 more)
...
Cohesion: 0.24
Nodes (7): Env, isProxiedPath(), onRequest(), PagesFunctionContext, TOP_LEVEL_PROXIED, assetRequests, proxiedRequests
...
Cohesion: 0.25
Nodes (7): Architecture at runtime, code:block1 (internet ──443──> Caddy (VM) ──:4000──> bun control plane (s), CodeRunner GCE Deployment, Cost notes, Sizing reference, Verification, What this provisions
...
Cohesion: 0.33
Nodes (6): Cloudflare Pages mode, code:block13 (student browser ──443──> Cloudflare Pages (coderunner)), code:bash (gh workflow run "Deploy to GCE" --ref main -f tag=v2.5.0), How it works, Ongoing releases, Rollback
...
Cohesion: 0.4
Nodes (5): Changing control-plane env vars, code:bash (sudo /opt/coderunner/render-env.sh && sudo systemctl restart), code:bash (gh workflow run "Deploy to GCE" --ref main -f tag=v2.3.0), code:bash (printf '<new value>' | gcloud secrets versions add coderunne), Rollback

### Community 658 - "Community 658"
Cohesion: 0.4
Nodes (5): code:bash (gh workflow run "Deploy to GCE" --ref main -f tag=v2.4.0), code:block19 (deploy/), Files, First-deploy gotcha, How releases deploy
...
## Knowledge Gaps
- **4037 isolated node(s):** `nosniff`, `cookie`, `console`, `consoleErrors`, `leaseErrors` (+4032 more)
...
- **Why does `Robot` connect `Community 57` to `Community 0`, `Community 32`, `Community 36`, `Community 666`, `Community 127`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 27` to `Community 24`, `Community 28`, `Community 15`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `Vision` connect `Community 192` to `Community 178`, `Community 5`?**

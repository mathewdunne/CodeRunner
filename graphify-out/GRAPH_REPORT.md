...
## Corpus Check
- 200 files · ~100,342 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2357 nodes · 3327 edges · 195 communities (181 shown, 14 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 21 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `35e68174`
...
## Communities (195 total, 14 thin omitted)
...
Cohesion: 0.07
Nodes (25): AppSocket, AssetManifest, BunUpgradeServer, createProjectArchive(), HOP_BY_HOP_HEADERS, LspSocketData, lspWebSocketResponse(), Nt4SocketData (+17 more)
...
Cohesion: 0.15
Nodes (14): EditorPane(), EditorPaneProps, ScopePane, ScopePaneProps, Topbar(), useContainerStatus(), EditorStatus, useEditorReachability() (+6 more)
...
Cohesion: 0.24
Nodes (11): RunControls(), RunControlsProps, pillVariant(), StatusStrip(), StatusStripProps, TopbarProps, RunConnection, RunStatus (+3 more)
...
Cohesion: 0.17
Nodes (13): 2.1 Clone and initialize, 2.2 Build container images, 2.2 Build the code container image, 2.3 Build web assets, 2.4 Configure environment, 2.5 Run migrations, 2. Initial Setup, code:bash (git clone <repo-url> FRC-Programming-Training-Sim) (+5 more)
...
Cohesion: 0.2
Nodes (11): 2.6 Verify the setup, 2.7 Measure host resources, 3. Starting the App, code:bash (curl http://localhost:4000/admin/status), code:bash (bun run docker:cleanup), code:bash (bun run typecheck), code:bash (bun run measure), code:bash (bun run dev:control) (+3 more)

### Community 80 - "Community 80"
Cohesion: 0.2
Nodes (11): 5. Configuration, code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), code:bash (bun run backup), Environment variables, Key settings for classroom use (+3 more)
...
- **Why does `isWorkspaceSlug()` connect `Community 10` to `Community 91`, `Community 6`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `App()` connect `Community 10` to `Community 3`?**

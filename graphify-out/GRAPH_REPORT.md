...
## Corpus Check
- 5208 files · ~3,641,297 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15150 nodes · 26652 edges · 1555 communities (1011 shown, 544 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 391 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3914abf1`
...
## Communities (1555 total, 544 thin omitted)
...
Cohesion: 0.01
Nodes (9): Command, DriveDistance, DriveTime, DriveToPoseCommand, SysIDCommands, m_autoTime(), LoggedRobot, SlowDriveSpeedCommand (+1 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (229): AuthenticationForceNewSessionOptions, AuthenticationGetSessionOptions, AuthenticationProvider, AuthenticationProviderInformation, AuthenticationSession, BranchCoverage, CallHierarchyItem, CallHierarchyOutgoingCall (+221 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (229): AccessibilityInformation, AuthenticationProviderAuthenticationSessionsChangeEvent, AuthenticationProviderOptions, AuthenticationSessionAccountInformation, AuthenticationSessionsChangeEvent, AutoClosingPair, Breakpoint, BreakpointsChangeEvent (+221 more)
...
Cohesion: 0.03
Nodes (93): handleUploadAsset(), userAssetsPath(), getSessionFromRequest(), requireAdmin(), requireSession(), input, stripped, apiError() (+85 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (91): ControlAppOptions, AuditLogEntry, DockerCommandResult, DockerRunner, RunCommandFactory, adminCookie, body, fakeDocker (+83 more)
...
Cohesion: 0.06
Nodes (55): body, body, body, body, absolute, refs, headers, received (+47 more)
...
Cohesion: 0.04
Nodes (11): Main, Main, Main, Main, Main, RobotBase, Main, Main (+3 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (70): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+62 more)
...
Cohesion: 0.05
Nodes (48): EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip() (+40 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (9): SetBrakeModeCommand, InstantCommand, ReplaceMeInstantCommand, RobotContainer, RobotContainer, getPose(), OverrideUtil, ShootingLocation() (+1 more)
...
Cohesion: 0.05
Nodes (48): sendUpstreamWebSocketMessage(), AppSocket, createWebSocketHandlers(), log, WebSocketHandlerContext, first, NUM_RUNS, second (+40 more)
...
Cohesion: 0.05
Nodes (35): AutoPanel(), AutoPanelProps, ControlsPanel(), ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES (+27 more)
...
Cohesion: 0.05
Nodes (4): OuttakeCommand, IntakeCommand, ShootIfReadyCommand, SimShotVisualizer
...
Cohesion: 0.04
Nodes (45): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.22.4, 0.24.1, 0.31.0, 0.31.3 (+37 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (45): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.33.1 - 2021-04-30 (+37 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (44): 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.33.1 - 2021-04-30 (+36 more)
...
Cohesion: 0.07
Nodes (32): IDELayout(), IDELayoutProps, Avatar(), InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimer(), MatchTimerProps (+24 more)
...
Cohesion: 0.07
Nodes (38): addAllowlistEntry(), AllowlistData, getAllowlist(), isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist() (+30 more)
...
Cohesion: 0.07
Nodes (6): RobotContainer, RobotContainer, ShootUntilHopperEmptyCommand, ShiftChangeRumbleLEDCommand, ParallelDeadlineGroup, ReplaceMeParallelDeadlineGroup
...
Cohesion: 0.12
Nodes (4): ContainerOrchestrator, dockerError(), portIsFree(), simContainerName()

### Community 71 - "Community 71"
Cohesion: 0.13
Nodes (3): containerRuntimeState(), LocalDockerRuntimeProvider, runtimeFromLease()
...
Cohesion: 0.06
Nodes (5): GyroIONavX, GyroIOPigeon2, GyroIOSim, ModuleIOSim, GyroIO
...
Cohesion: 0.08
Nodes (12): FakeNt4Handle, FakeNt4Options, startFakeNt4(), aliceMessages, aliceReady, aliceSocket, allAlice, allBob (+4 more)
...
Cohesion: 0.07
Nodes (23): 0.18.9, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0, 0.26.1 (+15 more)
...
Cohesion: 0.07
Nodes (28): 0.21.2, 0.23.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+20 more)
...
Cohesion: 0.16
Nodes (26): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Manual probe with bearer token), code:alloy (prometheus.scrape "control_plane" {) (+18 more)
...
Cohesion: 0.11
Nodes (14): waitFor(), announceChooser(), controlled, cookie, encodeMsgPack(), fakeDocker, FakeWebSocket, messages (+6 more)
...
Cohesion: 0.12
Nodes (13): ControlApp, ControlAppOptions, GamepadSocketData, HalSimSocketData, ImportSocketData, Nt4SocketData, RunSocketData, VscodeSocketData (+5 more)
...
Cohesion: 0.12
Nodes (14): slugFromEmail(), startFakeHalsim(), startFakeVscode(), AppFixture, FakeHalsimHandle, FakeVscodeHandle, SeededUser, SeededWorkspace (+6 more)
...
Cohesion: 0.15
Nodes (9): bridge, enabledDisable, FakeWebSocket, flush, joystick, messages, msg, sockets (+1 more)
...
Cohesion: 0.19
Nodes (4): FakeSocket, Listener, { result }, { unmount }
...
Cohesion: 0.33
Nodes (3): connectGamepad(), installGamepadShim(), setGamepadAxes()
...
## Knowledge Gaps
- **3729 isolated node(s):** `nosniff`, `cookie`, `console`, `consoleErrors`, `leaseErrors` (+3724 more)
...
- **Why does `Robot` connect `Community 87` to `Community 0`, `Community 2`, `Community 101`, `Community 118`, `Community 57`, `Community 31`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 57` to `Community 9`, `Community 18`, `Community 165`, `Community 25`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `isWorkspaceSlug()` connect `Community 59` to `Community 19`, `Community 102`?**

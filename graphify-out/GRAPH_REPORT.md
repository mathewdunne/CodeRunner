...
## Corpus Check
- 1067 files · ~734,983 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9154 nodes · 11639 edges · 1120 communities (713 shown, 407 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 281 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `adc7b9f4`
...
## Communities (1120 total, 407 thin omitted)
...
Cohesion: 0.04
Nodes (65): apiErrorResponse(), AppSocket, AssetManifest, authFromRequest(), autoChoosersSnapshot(), BunUpgradeServer, capacityErrorResponse(), containersStatusResponse() (+57 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (77): AdminActionResponse, adminActionResponseSchema, AdminStatusResponse, adminStatusResponseSchema, AdminWorkspaceStatus, adminWorkspaceStatusSchema, AllianceStation, allianceStationSchema (+69 more)
...
Cohesion: 0.06
Nodes (55): ControlAppOptions, DockerCommandResult, DockerRunner, RunCommandFactory, adminCookie, body, fakeDocker, rows (+47 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (4): ReplaceMeSubsystem, SubsystemBase, DriveSubsystem, SubsystemBase()

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (5): Command, DriveTime, RobotContainer(), ParallelRaceGroup, ReplaceMeParallelRaceGroup

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (36): AutoPanel(), AutoPanelProps, ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES, IconRail() (+28 more)
...
Cohesion: 0.06
Nodes (49): 1. Find your host IP, 1. Login And Isolation, 2. Editor And Project Persistence, 2. Start the control plane, 3. Connect from other machines, 3. File Operations, 4. Firewall (if needed), 4. Java IDE Features (+41 more)
...
Cohesion: 0.04
Nodes (48): 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.25.0 - 2020-02-20, 0.25.1 - 2020-03-06, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+40 more)
...
Cohesion: 0.08
Nodes (29): EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip() (+21 more)
...
Cohesion: 0.07
Nodes (4): PreSpinFlywheelCommand, SysIDCommands, ShooterSubsystem, AimHoodAndSpinFlywheelCommand
...
Cohesion: 0.07
Nodes (29): InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimer(), MatchTimerProps, STATION_LABELS, STATIONS, AllianceStation (+21 more)
...
Cohesion: 0.08
Nodes (5): IntakeCommand, IntakeControlCommand, IntakeSubsystem, Constants, SimShotVisualizer

### Community 31 - "Community 31"
Cohesion: 0.09
Nodes (29): addAllowlistEntry(), AllowlistData, isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist(), removeAllowlistEntry() (+21 more)
...
Cohesion: 0.07
Nodes (5): DefaultDrive, DoubleSupplier, ArcadeDriveCommand(), Drive, TunableDouble
...
Cohesion: 0.08
Nodes (25): BigButton(), BigButtonProps, EnableDisableRow(), EnableDisableRowProps, TONE_ACTIVE, MODE_CLASSES, MODE_LABELS, ModeColumn() (+17 more)
...
Cohesion: 0.09
Nodes (5): TrenchDuckCommand, ExampleGlobalMeasurementSensor, ExampleGlobalMeasurementSensor, ExampleGlobalMeasurementSensor, LaunchCalculator
...
Cohesion: 0.07
Nodes (29): 0.10.2, 0.1.0 - 2018-10-19, 0.23.4, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2 (+21 more)
...
Cohesion: 0.08
Nodes (4): TurretCommands, ControllerUtil, getPose(), OverrideUtil
...
Cohesion: 0.07
Nodes (26): consumeLines(), defaultRunCommandFactory(), dockerRunScript(), lineLooksReady(), randomRunId(), RunCommand, RunCommandContext, RunExit (+18 more)

### Community 60 - "Community 60"
Cohesion: 0.12
Nodes (23): ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange, loadControlConfig() (+15 more)
...
Cohesion: 0.12
Nodes (6): Initialize(), ReleaseHatch, SetBrakeModeCommand, InstantCommand, ReplaceMeInstantCommand, RobotContainer
...
Cohesion: 0.1
Nodes (20): code:block24 (vscjava.vscode-java-debug/getDebugThreads()), code:block25 (═══════════════════════════════════════════), code:bash (# Step 1: Find the Java process ID), code:block27 (Found one Java-level deadlock:), code:block28 (// Inspect variables in thread #15 (worker-2)), code:block29 (vscjava.vscode-java-debug/getDebugThreads()), code:markdown (## Hypothesis), code:block31 (// Check main thread's view) (+12 more)
...
Cohesion: 0.15
Nodes (15): CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun(), ConsoleLine(), ConsolePanel(), ConsolePanelProps, ConsoleTab (+7 more)
...
Cohesion: 0.17
Nodes (19): 13. Audit Log, 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 8. Monitoring, Between class sessions, code:bash (# Latest entries), code:bash (# Remove entries older than 90 days (default)) (+11 more)
...
Cohesion: 0.18
Nodes (19): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:bash (# Container is auto-recreated on next run. If persistent:), code:bash (# Restart the code container), code:bash (# 1. Prune run logs (safest, usually largest)) (+11 more)
...
Cohesion: 0.12
Nodes (15): authProvidersResponseSchema, autoChooserPatchSchema, autoChoosersResponseSchema, createFileRequestSchema, driverStationPatchSchema, getProjectPathAccess(), isProjectPath(), matchesPathOrChild() (+7 more)
...
Cohesion: 0.24
Nodes (13): getSessionFromRequest(), isAllowedWebSocketOrigin(), isLoopbackHost(), normalizeHost(), requireAdmin(), requireSession(), requireWebSocketOrigin(), requireWorkspaceOwnership() (+5 more)
...
Cohesion: 0.24
Nodes (11): 5. Configuration, code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), Environment variables, Key settings for classroom use (+3 more)

### Community 216 - "Community 216"
Cohesion: 0.2
Nodes (9): adminCookie, alice, aliceCookie, bob, bobCookie, body, fakeDocker, users (+1 more)
...
Cohesion: 0.38
Nodes (7): Admin status API, code:bash (docker system prune -f          # Remove unused containers, ), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run measure), code:bash (bun run measure -- --json), Docker container status, Resource measurement
...
Cohesion: 0.33
Nodes (4): code:java (if (object instanceof Integer) {), code:java (if (object instanceof Integer i) {), `instanceofPatternMatch`, Java Clean Ups
...
Cohesion: 0.67
Nodes (3): Alternative Thread Dump Methods, code:bash (# Launch JConsole), code:java (// Add before suspected deadlock area)
...
## Knowledge Gaps
- **3791 isolated node(s):** `workspaceSlugSchema`, `userIdSchema`, `workspaceIdSchema`, `displayNameSchema`, `workspaceRouteSchema` (+3786 more)
...
- **Why does `Robot` connect `Community 42` to `Community 2`, `Community 43`, `Community 30`, `Community 23`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 76` to `Community 59`, `Community 5`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `isWorkspaceSlug()` connect `Community 39` to `Community 134`, `Community 6`?**

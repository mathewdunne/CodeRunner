...
## Corpus Check
- 1074 files · ~735,793 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9083 nodes · 11447 edges · 1124 communities (717 shown, 407 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 278 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d311d435`
...
Cohesion: 0.02
Nodes (27): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+19 more)
...
Cohesion: 0.05
Nodes (70): ControlAppOptions, adminCookie, body, fakeDocker, rows, student, studentCookie, workspace (+62 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (64): apiError(), apiErrorResponse(), AppSocket, assertRealPathInside(), AssetManifest, authFromRequest(), BunUpgradeServer, capacityErrorResponse() (+56 more)
...
Cohesion: 0.03
Nodes (59): aliceConnection, aliceCookie, aliceMessages, aliceRun, aliceRunId, aliceWorkspace, authHeaders, backedUpProject (+51 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (29): EMPTY, RobotContainer, SubsystemFactory, applyAdvantageScopePatches(), ascopeRoot, CommandResult, patchDir, patchFiles() (+21 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (5): PreSpinFlywheelCommand, Command, ReplaceMeCommand, DriveTime, TurnTime
...
Cohesion: 0.04
Nodes (49): 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.2, 0.27.0, 0.30.0, 0.31.0, 0.31.1, 0.31.3 (+41 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (48): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+40 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (48): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21 (+40 more)
...
Cohesion: 0.07
Nodes (5): IntakeCommand, IntakeSubsystem, MoveIntakeToPositionCommand, RetractIntakeCommand, Constants

### Community 22 - "Community 22"
Cohesion: 0.08
Nodes (10): AutonomousDistance, AutonomousTime, ComplexAuto, DriveToClimbPoseSequentialCommand, ConfigureBindings(), ConfigureButtonBindings(), GetAutonomousCommand(), RobotContainer() (+2 more)
...
Cohesion: 0.07
Nodes (28): DockerRunner, ImportContext, ImportError, ImportManager, ImportManagerOptions, ImportRateLimiter, ImportSend, listRecentImports() (+20 more)

### Community 27 - "Community 27"
Cohesion: 0.08
Nodes (27): InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimer(), MatchTimerProps, STATION_LABELS, STATIONS, AllianceStation (+19 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (20): BridgeEntry, DEFAULT_DRIVER_STATION, defaultSnapshot(), DriverStationState, HalSimBridge, HalSimBridgeOptions, HalSimBridgeSnapshot, HalSimBridgeUnavailableError (+12 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (6): DoubleSupplier, SparkOdometryThread, ArcadeDriveCommand(), Drive, SysIdRoutineBot, TunableDouble
...
Cohesion: 0.08
Nodes (5): DefaultCommands, OperatorPanel, TurretCommands, getPose(), OverrideUtil

### Community 37 - "Community 37"
Cohesion: 0.09
Nodes (25): ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES, IconRail(), IconRailButton(), IconRailButtonProps (+17 more)

### Community 38 - "Community 38"
Cohesion: 0.08
Nodes (6): TrenchDuckCommand, ExampleGlobalMeasurementSensor, ExampleGlobalMeasurementSensor, SimShotVisualizer, ExampleGlobalMeasurementSensor, LaunchCalculator

### Community 39 - "Community 39"
Cohesion: 0.08
Nodes (25): CodeStatus, CodeStatusPill(), TONES, codeStatusFromRun(), ConsoleLine(), ConsolePanel(), ConsolePanelProps, ConsoleTab (+17 more)

### Community 40 - "Community 40"
Cohesion: 0.09
Nodes (22): EditorPane(), EditorPaneProps, IDELayout(), IDELayoutProps, ScopePane, ScopePaneProps, Topbar(), useContainerStatus() (+14 more)
...
Cohesion: 0.08
Nodes (8): Initialize(), ReleaseHatch, SetBrakeModeCommand, InstantCommand, ReplaceMeInstantCommand, RobotContainer, RobotContainer, RobotContainer

### Community 47 - "Community 47"
Cohesion: 0.06
Nodes (7): FlywheelIOSpark, KickerIOSim, KickerIOSpark, KickerIO, SpindexerIOSim, SpindexerIOSpark, SpindexerIO
...
Cohesion: 0.07
Nodes (29): 0.18.9, 0.19.1, 0.21.2, 0.23.6, 0.23.7, 0.24.0, 0.24.1, 0.25.0 (+21 more)
...
Cohesion: 0.08
Nodes (6): GyroIOSim, ModuleIOSim, ModuleIOSpark, GyroIO, ModuleIO, SparkUtil
...
Cohesion: 0.09
Nodes (22): defaultRunCommandFactory(), dockerRunScript(), RunCommand, RunCommandContext, RunCommandFactory, RunExit, RunJob, RunManagerOptions (+14 more)
...
Cohesion: 0.09
Nodes (5): FlywheelIOSim, FlywheelIO, HoodIOSim, HoodIOSpark, HoodIO
...
Cohesion: 0.13
Nodes (13): ConsolePane(), ConsolePaneProps, ImportDialogProps, Step, Dialog(), DialogContent(), DialogDescription(), DialogFooter() (+5 more)
...
Cohesion: 0.1
Nodes (5): ExtensionIOSpark, ExtensionIO, RollerIOSim, RollerIOSpark, RollerIO

### Community 84 - "Community 84"
Cohesion: 0.16
Nodes (21): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (bun run measure), code:bash (bun run measure -- --json), code:bash (# All managed containers), code:bash (# Container is auto-recreated on next run. If persistent:) (+13 more)
...
Cohesion: 0.1
Nodes (20): 3.16.0, 3.16.1, 3.16.3, 3.16.4, 3.17.0, 3.17.1, 3.17.2, 3.17.3 (+12 more)

### Community 89 - "Community 89"
Cohesion: 0.1
Nodes (20): 3.14.0, 3.16.0, 3.16.1, 3.16.3, 3.16.4, 3.17.0, 3.17.1, 3.17.2 (+12 more)
...
Cohesion: 0.14
Nodes (14): Auth, AuthCallbacks, createAuth(), buildSocialProviders(), SocialProviders, ControlConfig, ControlConfigInput, ContainerLeaseRow (+6 more)
...
Cohesion: 0.14
Nodes (19): 2.1 Clone and initialize, 2.2 Build container images, 2.2 Build the code container image, 2.3 Build web assets, 2.4 Configure environment, 2.5 Run migrations, 2.6 Verify the setup, 2.7 Measure host resources (+11 more)
...
Cohesion: 0.22
Nodes (14): addAllowlistEntry(), AllowlistData, isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist(), removeAllowlistEntry() (+6 more)
...
Cohesion: 0.17
Nodes (17): getSessionFromRequest(), isAllowedWebSocketOrigin(), isLoopbackHost(), normalizeHost(), requireAdmin(), requireSession(), requireWebSocketOrigin(), requireWorkspaceOwnership() (+9 more)
...
Cohesion: 0.24
Nodes (15): ArcadeDrive(), GetAccelX(), GetAccelY(), GetAccelZ(), GetAverageDistance(), GetGyroAngleX(), GetGyroAngleY(), GetGyroAngleZ() (+7 more)
...
Cohesion: 0.17
Nodes (14): defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange, loadControlConfig(), parseBoolean() (+6 more)
...
Cohesion: 0.21
Nodes (16): 7. Cache Cleanup, Admin status API, code:bash (bun run restore -- <backup-dir> --dry-run), code:bash (bun run docker:cleanup), code:bash (bun run docker:cleanup -- --dry-run), code:bash (rm -rf data/users/<workspaceId>/home/), code:bash (rm -rf data/users/<workspaceId>/logs/runs/*), code:bash (for dir in data/users/*/; do) (+8 more)
...
Cohesion: 0.23
Nodes (12): 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 8. Monitoring, Between class sessions, FRC Web Simulator V1 — Operator Runbook, FRC Web Simulator V2 — Operator Runbook, Graceful stop (+4 more)
...
Cohesion: 0.21
Nodes (12): 10. Host Sizing, code:bash (# Check Docker is running), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" \), code:bash (bun run measure), code:block41 (═══ FRC Web Simulator — Resource Report ═══), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=3072m), Measuring actual usage (+4 more)
...
Cohesion: 0.44
Nodes (8): AppliedMigrationRow, applyMigrations(), ensureMigrationTable(), listAppliedMigrations(), loadMigrations(), Migration, MigrationStatus, verifyAppliedMigrationChecksums()

### Community 231 - "Community 231"
Cohesion: 0.28
Nodes (9): 6. Backup and Restore, code:bash (bun run backup), code:bash (bun run backup -- --output /path/to/backup), code:bash (bun run restore -- <backup-dir>), code:bash (bun run restore -- <backup-dir> --workspace ws_abc123...), Create a backup, Recommended backup schedule, Restore from backup (+1 more)
...
Cohesion: 0.33
Nodes (5): BigButton(), BigButtonProps, EnableDisableRow(), EnableDisableRowProps, TONE_ACTIVE
...
Cohesion: 0.33
Nodes (4): `addFinalModifier`, code:java (private int i= 0;), code:java (private final int i= 0;), Java Clean Ups
...
## Knowledge Gaps
- **3797 isolated node(s):** `workspaceSlugSchema`, `userIdSchema`, `workspaceIdSchema`, `displayNameSchema`, `workspaceRouteSchema` (+3792 more)
...
- **Why does `Robot` connect `Community 3` to `Community 9`, `Community 58`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 58` to `Community 73`, `Community 6`?**

...
## Corpus Check
- 5212 files · ~3,647,859 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15084 nodes · 26513 edges · 1544 communities (1008 shown, 536 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 391 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d82a16b2`
...
## Communities (1544 total, 536 thin omitted)
...
Cohesion: 0.01
Nodes (11): StopDrivingCommand, WaitUntilHopperIsEmptyCommand, Command, ReplaceMeCommand, ArcadeDrive, DriveDistance, DriveTime, DriveToPoseCommand (+3 more)
...
Cohesion: 0.03
Nodes (229): AccessibilityInformation, AuthenticationProvider, AuthenticationProviderOptions, AuthenticationSession, AuthenticationSessionAccountInformation, AuthenticationSessionsChangeEvent, AutoClosingPair, BranchCoverage (+221 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (229): AuthenticationForceNewSessionOptions, AuthenticationGetSessionOptions, AuthenticationProviderAuthenticationSessionsChangeEvent, AuthenticationProviderInformation, BreakpointsChangeEvent, CallHierarchyIncomingCall, CallHierarchyItem, CallHierarchyOutgoingCall (+221 more)
...
Cohesion: 0.02
Nodes (144): ADMIN_GET_ROUTES, adminCookie, cookie, req, studentCookie, ControlAppOptions, createApp(), AuditLogEntry (+136 more)
...
Cohesion: 0.02
Nodes (20): RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer, RobotContainer (+12 more)
...
Cohesion: 0.04
Nodes (82): webShellResponse(), halsimWebSocketResponse(), HOP_BY_HOP_HEADERS, log, nt4AliveResponse(), nt4WebSocketResponse(), probeVscodeReady(), requestedProtocols() (+74 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (11): DoubleSupplier, ExtensionIOSpark, FlywheelIOSpark, KickerIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand, SpindexerIOSpark, Drive (+3 more)
...
Cohesion: 0.04
Nodes (57): parseDockerStatsLine(), parsePercent(), runtimeFromLease(), statusFromLease(), defaultDockerRunner(), dockerError(), dockerPortBindError(), inspectContainer() (+49 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (82): AdminRouteContext, handleAdminRoute(), log, createProjectArchive(), directorySizeBytes(), restoreProjectArchive(), runTar(), AssetManifest (+74 more)
...
Cohesion: 0.04
Nodes (55): ConsolePane(), ConsolePaneProps, IDELayout(), IDELayoutProps, Avatar(), InitialsAvatar(), UserMenuProps, CodeStatus (+47 more)
...
Cohesion: 0.05
Nodes (42): EditorPane(), EditorPaneProps, ScopePane, ScopePaneProps, Topbar(), TopbarProps, patchCall, { result } (+34 more)
...
Cohesion: 0.05
Nodes (50): ControlConfigInput, defaultContainerUser(), defaultDataDir, defaultHalsimPortRange, defaultLspPortRange, defaultSimPortRange, defaultVscodePortRange, loadControlConfig() (+42 more)

### Community 32 - "Community 32"
Cohesion: 0.06
Nodes (37): RunControls(), RunControlsProps, pillVariant(), StatusStrip(), StatusStripProps, AutoPanel(), AutoPanelProps, ALLIANCE_LABELS (+29 more)
...
Cohesion: 0.04
Nodes (45): 0.15.1 - 2019-03-19, 0.22.2, 0.22.4, 0.24.1, 0.30.0, 0.30.1, 0.31.0, 0.31.1 (+37 more)

### Community 40 - "Community 40"
Cohesion: 0.04
Nodes (44): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+36 more)

### Community 41 - "Community 41"
Cohesion: 0.04
Nodes (44): 0.12.1 - 2018-8-31, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+36 more)
...
Cohesion: 0.06
Nodes (27): UserMenu(), BINDING_GROUPS, Bumper(), ControlsPanel(), ControlsPanelProps, DpadArm(), FaceButton(), GamepadVisualizer() (+19 more)
...
Cohesion: 0.09
Nodes (22): IconRail(), IconRailButton(), IconRailButtonProps, IconRailProps, RailTab, SimControls(), SimControlsProps, LED_CLASSES (+14 more)
...
Cohesion: 0.07
Nodes (28): 0.18.7, 0.23.4, 0.23.7, 0.24.0, 0.24.1, 0.25.0, 0.25.2, 0.26.0 (+20 more)
...
Cohesion: 0.16
Nodes (15): body, body, body, body, absolute, refs, test, cookieHeader() (+7 more)
...
Cohesion: 0.11
Nodes (25): 2.1 Clone and initialize, 2.2 Build container images, 2.2 Build the code container image, 2.3 Build web assets, 2.4 Configure environment, 2.5 Run migrations, 2.6 Verify the setup, 2.7 Measure host resources (+17 more)
...
Cohesion: 0.26
Nodes (12): AllianceTest, AutonomousTest, callback(), EnabledTest, I2CCommunicationTest, MatchTimeTest, TEST_P(), AutoConstants (+4 more)
...
Cohesion: 0.09
Nodes (3): ModuleIOTalonFX, ModuleIO, PhoenixUtil
...
Cohesion: 0.19
Nodes (20): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, Code container OOM, code:bash (# All managed containers), code:block33 (14:23:01.482 INFO  [control.runs]       run started workspac), code:bash (# Container is auto-recreated on next run. If persistent:), code:bash (# Restart the code container) (+12 more)
...
Cohesion: 0.15
Nodes (12): headers, received, seedRuntimeMissing(), seedRuntimeRunning(), snapshot, cookie, frames, snap (+4 more)
...
Cohesion: 0.2
Nodes (18): 12. Container Concurrency Cap, 13. Audit Log, 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 7. Cache Cleanup, 8. Monitoring, Between class sessions (+10 more)
...
Cohesion: 0.13
Nodes (16): 11. Project Import, code:bash (CODE_MEMORY_LIMIT=3072m), code:block45 (data/users/<workspaceId>/backups/import-<timestamp>.tar.gz  ), code:bash (# Find the backup path), code:bash (MAX_ACTIVE_CONTAINERS=10   # default), code:bash (# Read current cap), code:bash (# Latest entries), code:bash (# Remove entries older than 90 days (default)) (+8 more)
...
Cohesion: 0.19
Nodes (14): 6. Backup and Restore, code:bash (bun run backup), code:bash (bun run backup -- --output /path/to/backup), code:bash (bun run restore -- <backup-dir>), code:bash (bun run restore -- <backup-dir> --dry-run), code:bash (bun run restore -- <backup-dir> --workspace ws_abc123...), code:bash (bun run docker:cleanup), code:bash (bun run docker:cleanup -- --dry-run) (+6 more)
...
Cohesion: 0.28
Nodes (12): code:powershell (git submodule update --init --recursive), code:text (apps/control/                  Bun control plane with login,), code:text (apps/control/src/__tests__/        Bun tests: auth, runs, pr), CodeRunner, Commands, FRC Web Simulator, FRC Web Simulator V1, Layout (+4 more)

### Community 283 - "Community 283"
Cohesion: 0.22
Nodes (13): Admin status API, code:bash (rm -rf data/users/<workspaceId>/home/), code:bash (rm -rf data/users/<workspaceId>/logs/runs/*), code:bash (for dir in data/users/*/; do), code:bash (docker system prune -f          # Remove unused containers, ), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run measure), code:bash (bun run measure -- --json) (+5 more)
...
Cohesion: 0.27
Nodes (11): 10. Host Sizing, code:bash (# Check Docker is running), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" \), code:bash (bun run measure), code:block42 (═══ CodeRunner — Resource Report ═══), code:bash (CODE_MEMORY_LIMIT=2048m), Measuring actual usage, Per-student resource usage (+3 more)
...
Cohesion: 0.28
Nodes (9): 5. Configuration, code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), Environment variables, Key settings for classroom use, Tuning for constrained hosts (+1 more)
...
## Knowledge Gaps
- **3711 isolated node(s):** `nosniff`, `cookie`, `console`, `consoleErrors`, `leaseErrors` (+3706 more)
...
- **Why does `Robot` connect `Community 51` to `Community 0`, `Community 295`, `Community 55`, `Community 633`, `Community 30`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 55` to `Community 16`, `Community 12`, `Community 14`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `isWorkspaceSlug()` connect `Community 57` to `Community 92`, `Community 23`?**

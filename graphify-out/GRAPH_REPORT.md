...
## Corpus Check
- 1066 files · ~705,174 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9138 nodes · 11546 edges · 1150 communities (716 shown, 434 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 281 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `735eb365`
...
## Communities (1150 total, 434 thin omitted)
...
Cohesion: 0.03
Nodes (74): AdminActionResponse, adminActionResponseSchema, AdminStatusResponse, adminStatusResponseSchema, AdminWorkspaceStatus, adminWorkspaceStatusSchema, AllianceStation, allianceStationSchema (+66 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (58): requireWebSocketOrigin(), apiErrorResponse(), AppSocket, AssetManifest, authFromRequest(), autoChoosersSnapshot(), BunUpgradeServer, capacityErrorResponse() (+50 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (54): ControlAppOptions, DockerCommandResult, DockerRunner, RunCommandFactory, adminCookie, body, fakeDocker, rows (+46 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (5): WaitUntilHopperIsEmptyCommand, Command, DriveTime, ExampleCommand, IntakeControlCommand

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (36): EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip() (+28 more)
...
Cohesion: 0.04
Nodes (49): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.24.1, 0.27.0, 0.30.0, 0.30.1, 0.31.0 (+41 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (49): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+41 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (49): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.27.1 - 2020-07-21, 0.33.1 - 2021-04-30 (+41 more)
...
Cohesion: 0.07
Nodes (35): Auth, AuthCallbacks, createAuth(), getSessionFromRequest(), isAllowedWebSocketOrigin(), isLoopbackHost(), normalizeHost(), requireAdmin() (+27 more)

### Community 21 - "Community 21"
Cohesion: 0.07
Nodes (29): InitialsAvatar(), UserMenuProps, BigButton(), BigButtonProps, EnableDisableRow(), EnableDisableRowProps, TONE_ACTIVE, MatchTimer() (+21 more)
...
Cohesion: 0.06
Nodes (4): ReplaceMeSubsystem, SubsystemBase, SubsystemBase(), Storage
...
Cohesion: 0.07
Nodes (29): 0.18.9, 0.1.0 - 2018-10-19, 0.23.2, 0.23.6, 0.23.7, 0.24.0, 0.24.1, 0.25.0 (+21 more)
...
Cohesion: 0.11
Nodes (15): BridgeEntry, DEFAULT_DRIVER_STATION, defaultSnapshot(), DriverStationState, HalSimBridge, HalSimBridgeOptions, HalSimBridgeSnapshot, HalSimBridgeUnavailableError (+7 more)
...
Cohesion: 0.17
Nodes (23): acceptWebSocket(), ActiveRun, activeRuns, collectProcess(), delay(), docker(), dockerExec(), killChild() (+15 more)
...
Cohesion: 0.09
Nodes (6): KickerIOSim, KickerIOSpark, KickerIO, SpindexerIOSim, SpindexerIOSpark, SpindexerIO
...
Cohesion: 0.13
Nodes (3): IntakeCommand, Constants, SimShotVisualizer
...
Cohesion: 0.1
Nodes (5): FlywheelIOSim, FlywheelIOSpark, FlywheelIO, HoodIOSim, HoodIO
...
Cohesion: 0.1
Nodes (20): [3.12.5](https://github.com/microsoft/vscode-gradle/compare/3.12.4...3.12.5) (2022-09-28), 3.16.0, 3.16.1, 3.16.3, 3.16.4, 3.17.0, 3.17.1, 3.17.2 (+12 more)
...
Cohesion: 0.13
Nodes (3): TurretIOTalonFX, VisionIOPhotonVision, VisionIO

### Community 119 - "Community 119"
Cohesion: 0.14
Nodes (3): HopperSubsystem, VisionIOPhotonVisionSim, VisionIOPhotonVision
...
Cohesion: 0.17
Nodes (16): 5. Configuration, 6. Backup and Restore, code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), code:bash (bun run backup), code:bash (bun run backup -- --output /path/to/backup), code:bash (bun run restore -- <backup-dir>) (+8 more)
...
Cohesion: 0.13
Nodes (4): GyroIOSim, ModuleIOSim, GyroIO, ModuleIO

### Community 139 - "Community 139"
Cohesion: 0.17
Nodes (6): AutoCloseable, Elevator, ReachGoal(), SimulationPeriodic(), Stop(), UpdateTelemetry()
...
Cohesion: 0.13
Nodes (14): autoChooserPatchSchema, autoChoosersResponseSchema, createFileRequestSchema, driverStationPatchSchema, getProjectPathAccess(), isProjectPath(), matchesPathOrChild(), parseProjectPath() (+6 more)
...
Cohesion: 0.22
Nodes (13): 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 7. Cache Cleanup, 8. Monitoring, Between class sessions, FRC Web Simulator V1 — Operator Runbook, FRC Web Simulator V2 — Operator Runbook (+5 more)
...
Cohesion: 0.15
Nodes (4): ExtensionIO, RollerIOSim, RollerIOSpark, RollerIO
...
Cohesion: 0.21
Nodes (3): handleRun(), LineSplitter, WebSocketTextPeer
...
Cohesion: 0.21
Nodes (5): bridge, FakeWebSocket, messages, msg, sockets
...
Cohesion: 0.18
Nodes (10): adminCookie, alice, aliceCookie, bob, bobCookie, body, fakeDocker, users (+2 more)
...
Cohesion: 0.28
Nodes (8): commsToneFromConnections(), robotToneFromRunStatus(), StatusTile(), StatusTileProps, StatusTileRow(), StatusTileRowProps, StatusTone, TONE_CLASSES

### Community 241 - "Community 241"
Cohesion: 0.22
Nodes (5): HalSimActions, HalSimMessage, HalSimState, STATION_VALUES, UseHalSimReturn
...
Cohesion: 0.32
Nodes (8): code:bash (bun run measure), code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (# Stop all workspaces), One-command start, Stop containers too, Verify the app is running
...
Cohesion: 0.33
Nodes (4): code:java (J j = (a, b) -> System.out.println(a);), code:java (J j = (a, _) -> System.out.println(a);), Java Clean Ups, `renameUnusedLocalVariables`
...
## Knowledge Gaps
- **3808 isolated node(s):** `workspaceSlugSchema`, `userIdSchema`, `workspaceIdSchema`, `displayNameSchema`, `workspaceRouteSchema` (+3803 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **434 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Robot` connect `Community 38` to `Community 74`, `Community 3`, `Community 109`, `Community 22`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 30` to `Community 7`?**

...
## Corpus Check
- 1075 files · ~742,590 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9267 nodes · 11808 edges · 1148 communities (708 shown, 440 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 283 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bc402de3`
...
## Communities (1148 total, 440 thin omitted)
...
Cohesion: 0.02
Nodes (25): Robot, Robot, Robot, Robot, Robot, Robot, Robot, Robot (+17 more)
...
Cohesion: 0.04
Nodes (83): ControlAppOptions, DockerCommandResult, DockerRunner, adminCookie, body, fakeDocker, rows, student (+75 more)
...
Cohesion: 0.05
Nodes (41): ConsolePane(), ConsolePaneProps, InitialsAvatar(), UserMenu(), UserMenuProps, MatchTimer(), MatchTimerProps, STATION_LABELS (+33 more)
...
Cohesion: 0.06
Nodes (48): Auth, AuthCallbacks, createAuth(), getSessionFromRequest(), isAllowedWebSocketOrigin(), isLoopbackHost(), normalizeHost(), requireAdmin() (+40 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (4): Command, DriveDistance, DriveTime, IntakeControlCommand
...
Cohesion: 0.08
Nodes (32): EditorPane(), EditorPaneProps, RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip() (+24 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (32): AutoPanel(), AutoPanelProps, ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES, IconRail() (+24 more)
...
Cohesion: 0.04
Nodes (49): 0.18.2 - 2019-07-23, 0.22.2, 0.22.4, 0.27.0, 0.30.0, 0.31.0, 0.31.1, 0.31.3 (+41 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (48): 0.12.1 - 2018-8-31, 0.14.0 - 2018-10-10, 0.19.0 - 2019-05-31, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+40 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (48): 0.12.1 - 2018-8-31, 0.12.2 - 2018-9-6, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30 (+40 more)
...
Cohesion: 0.06
Nodes (6): DoubleSupplier, ModuleIOSpark, SparkOdometryThread, ArcadeDriveCommand(), Drive, TunableDouble
...
Cohesion: 0.07
Nodes (29): 0.10.1, 0.18.7, 0.23.1, 0.23.2, 0.23.7, 0.24.0, 0.24.1, 0.25.0 (+21 more)
...
Cohesion: 0.12
Nodes (23): addAllowlistEntry(), AllowlistData, isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist(), removeAllowlistEntry() (+15 more)
...
Cohesion: 0.1
Nodes (3): ControllerUtil, getPose(), OverrideUtil
...
Cohesion: 0.11
Nodes (4): TurretIOSim, TurretIOSpark, TurretIOTalonFX, TurretIO

### Community 90 - "Community 90"
Cohesion: 0.13
Nodes (6): Initialize(), ReleaseHatch, SetBrakeModeCommand, InstantCommand, ReplaceMeInstantCommand, ReplaceMeParallelDeadlineGroup
...
Cohesion: 0.16
Nodes (3): TurretCommands, AllianceFlipUtil, FieldConstants
...
Cohesion: 0.15
Nodes (3): GyroIONavX, VisionIOPhotonVision, VisionIO
...
Cohesion: 0.18
Nodes (10): Depot, Hub, LeftBump, LeftTrench, LinesHorizontal, LinesVertical, Outpost, RightBump (+2 more)
...
Cohesion: 0.28
Nodes (3): ShootUntilHopperEmptyCommand, ShiftChangeRumbleLEDCommand, ParallelDeadlineGroup
...
Cohesion: 0.33
Nodes (4): code:java (if (isValid) {), code:java (if (isValid) {), Java Clean Ups, `redundantIfCondition`
...
## Knowledge Gaps
- **3844 isolated node(s):** `workspaceSlugSchema`, `userIdSchema`, `workspaceIdSchema`, `displayNameSchema`, `workspaceRouteSchema` (+3839 more)
...
- **Why does `Robot` connect `Community 40` to `Community 25`, `Community 3`, `Community 166`, `Community 31`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 31` to `Community 4`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `isWorkspaceSlug()` connect `Community 37` to `Community 7`, `Community 103`?**

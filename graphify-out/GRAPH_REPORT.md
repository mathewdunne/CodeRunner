# Graph Report - FRC-Programming-Training-Sim  (2026-05-13)

## Corpus Check
- 5116 files · ~3,596,061 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14346 nodes · 25076 edges · 1487 communities (958 shown, 529 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 374 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5f33f19f`
...
## Communities (1487 total, 529 thin omitted)
...
Cohesion: 0.01
Nodes (9): Command, DriveDistance, DriveTime, DriveToPoseCommand, OuttakeCommand, TurnDegrees, m_autoTime(), IntakeCommand (+1 more)
...
Cohesion: 0.03
Nodes (229): AuthenticationForceNewSessionOptions, AuthenticationGetSessionOptions, AuthenticationProviderAuthenticationSessionsChangeEvent, AuthenticationProviderInformation, AuthenticationProviderOptions, AuthenticationSession, AuthenticationSessionAccountInformation, CallHierarchyIncomingCall (+221 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (229): AccessibilityInformation, AuthenticationProvider, AuthenticationSessionsChangeEvent, AutoClosingPair, BranchCoverage, Breakpoint, BreakpointsChangeEvent, CancellationToken (+221 more)
...
Cohesion: 0.03
Nodes (126): ControlAppOptions, createApp(), DockerRunner, RunCommandFactory, adminCookie, body, fakeDocker, rows (+118 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (98): getSessionFromRequest(), isAllowedWebSocketOrigin(), isLoopbackHost(), normalizeHost(), requireAdmin(), requireSession(), requireWebSocketOrigin(), requireWorkspaceOwnership() (+90 more)
...
Cohesion: 0.06
Nodes (35): CodeContainerStatus, containerName(), ContainerOrchestrator, ContainerOrchestratorOptions, containerRuntimeState(), defaultDockerRunner(), DockerCommandResult, dockerError() (+27 more)
...
Cohesion: 0.04
Nodes (10): Initialize(), IsFinished(), ReleaseHatch, SetBrakeModeCommand, InstantCommand, ReplaceMeInstantCommand, RobotContainer, ReplaceMeParallelDeadlineGroup (+2 more)
...
Cohesion: 0.06
Nodes (52): addAllowlistEntry(), AllowlistData, isEmailAllowed(), loadAllowlist(), normalize(), normalizeEntry(), reloadAllowlist(), removeAllowlistEntry() (+44 more)
...
Cohesion: 0.06
Nodes (36): RunControls(), RunControlsProps, ScopePane, ScopePaneProps, pillVariant(), StatusStrip(), StatusStripProps, Topbar() (+28 more)
...
Cohesion: 0.06
Nodes (6): DoubleSupplier, FlywheelIOSpark, RollerIOSpark, AimHoodAndSpinFlywheelCommand, Drive, SparkUtil
...
Cohesion: 0.04
Nodes (45): 0.15.1 - 2019-03-19, 0.18.2 - 2019-07-23, 0.1.0 - 2017-12-01, 0.22.4, 0.24.1, 0.30.1, 0.31.1, 0.31.3 (+37 more)

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (45): 0.12.1 - 2018-8-31, 0.14.0 - 2018-10-10, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23, 0.33.1 - 2021-04-30, 0.34.0 - 2021-05-26 (+37 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (3): TrenchDuckCommand, LaunchCalculator, ChassisTrapezoidalController

### Community 34 - "Community 34"
Cohesion: 0.04
Nodes (44): 0.10.0 - 2018-6-27, 0.14.0 - 2018-10-10, 0.15.0 - 2018-11-01, 0.1.0 - 2017-09-27, 0.20.0 - 2019-07-01, 0.25.1 - 2020-03-06, 0.27.1 - 2020-07-21, 0.32.1 - 2021-03-23 (+36 more)
...
Cohesion: 0.08
Nodes (28): EditorPane(), EditorPaneProps, useAutoChoosers(), UseAutoChoosersReturn, useContainerStatus(), EditorStatus, useEditorReachability(), GamepadFrame (+20 more)
...
Cohesion: 0.06
Nodes (29): assert(), assertEditorProxy(), assertNt4AliveProbe(), assertSimProcessAlive(), buildingTimes, Login, logins, originals (+21 more)
...
Cohesion: 0.12
Nodes (3): codeContainerName(), LocalDockerRuntimeProvider, runtimeFromLease()
...
Cohesion: 0.07
Nodes (28): BigButton(), BigButtonProps, EnableDisableRow(), EnableDisableRowProps, TONE_ACTIVE, MODE_CLASSES, MODE_LABELS, ModeColumn() (+20 more)
...
Cohesion: 0.07
Nodes (5): IntakeControlCommand, ControllerUtil, getPose(), OverrideUtil, ShootingLocation()
...
Cohesion: 0.11
Nodes (13): AutoPanel(), AutoPanelProps, ControlsPanel(), ALLIANCE_LABELS, DriverStation(), DriverStationProps, MODE_LABELS, MODE_PILL_CLASSES (+5 more)

### Community 103 - "Community 103"
Cohesion: 0.1
Nodes (17): IdleManager, IdleManagerOptions, defaultRunCommandFactory(), dockerRunScript(), RunCommand, RunCommandContext, RunExit, RunJob (+9 more)
...
Cohesion: 0.15
Nodes (22): 13. Audit Log, 1. Prerequisites, 3. Starting the App, 4. Stopping the App, 5. Configuration, 8. Monitoring, Between class sessions, code:bash (# Latest entries) (+14 more)
...
Cohesion: 0.12
Nodes (13): announceChooser(), controlled, cookie, encodeMsgPack(), fakeDocker, FakeWebSocket, messages, secondTextMessages (+5 more)
...
Cohesion: 0.1
Nodes (4): GyroIONavX, GyroIOPigeon2, PhoenixOdometryThread, GyroIO
...
Cohesion: 0.16
Nodes (16): 2.1 Clone and initialize, 2.2 Build container images, 2.2 Build the code container image, 2.3 Build web assets, 2.4 Configure environment, 2.5 Run migrations, 2.6 Verify the setup, 2. Initial Setup (+8 more)

### Community 218 - "Community 218"
Cohesion: 0.16
Nodes (16): 6. Backup and Restore, code:bash (# Stop all workspaces), code:bash (docker stop $(docker ps -q --filter label=frc-sim.managed=tr), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=2560m), code:bash (bun run backup), code:bash (bun run backup -- --output /path/to/backup), code:bash (bun run restore -- <backup-dir>) (+8 more)
...
Cohesion: 0.22
Nodes (15): 9. Common Failures and Recovery, AS Lite not showing telemetry, Build queue saturated, code:bash (# Container is auto-recreated on next run. If persistent:), code:bash (# Restart the code container), code:bash (# 1. Prune run logs (safest, usually largest)), code:bash (bun run dev:control), code:bash (bun run migrate:status  # verify DB is accessible) (+7 more)
...
Cohesion: 0.23
Nodes (12): digitalAxis(), dpadToPov(), gamepadStateToVisualizerFrame(), isMappedKeyboardCode(), KEYBOARD_BINDINGS, KeyboardBindingGroup, keyboardCodesToWpilib(), MAPPED_CODES (+4 more)

### Community 240 - "Community 240"
Cohesion: 0.16
Nodes (12): BridgeEntry, DEFAULT_DRIVER_STATION, DriverStationState, HalSimBridgeOptions, HalSimBridgeSnapshot, HalSimMessage, HalSimWebSocketFactory, JoystickWireState (+4 more)
...
Cohesion: 0.21
Nodes (12): 10. Host Sizing, code:bash (# Check Docker is running), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" \), code:bash (bun run measure), code:block41 (═══ CodeRunner — Resource Report ═══), code:bash (CODE_MEMORY_LIMIT=2048m), code:bash (CODE_MEMORY_LIMIT=3072m), Measuring actual usage (+4 more)
...
Cohesion: 0.27
Nodes (10): Admin status API, Code container OOM, code:bash (docker system prune -f          # Remove unused containers, ), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run measure), code:bash (bun run measure -- --json), code:bash (# All managed containers), Docker container status (+2 more)
...
Cohesion: 0.31
Nodes (9): 2.7 Measure host resources, code:bash (bun run measure), code:bash (bun run dev:control), code:bash (curl -H "Authorization: Bearer $ADMIN_TOKEN" http://localhos), code:bash (bun run docker:cleanup), code:bash (bun run typecheck), One-command start, Stop containers too (+1 more)
...
## Knowledge Gaps
- **3373 isolated node(s):** `workspaceSlugSchema`, `userIdSchema`, `workspaceIdSchema`, `displayNameSchema`, `workspaceRouteSchema` (+3368 more)
...
- **Why does `Robot` connect `Community 54` to `Community 0`, `Community 638`, `Community 222`, `Community 87`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `RunManager` connect `Community 92` to `Community 10`, `Community 103`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `isWorkspaceSlug()` connect `Community 55` to `Community 16`, `Community 163`?**
